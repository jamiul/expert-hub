...
//social login
Route::get('/facebook/auth/redirect', [SocialLoginController::class, 'facebookRedirect'])->middleware('guest')>name('auth.facebook.redirect');
Route::get('/facebook/auth/callback', [SocialLoginController::class, 'facebookCallback'])->middleware('guest')>name('auth.facebook.callback');

...
class TrainingDetailsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.training_module.training.index', compact('scholarships', 'sort_search'));
    }

    public function details()
    {
        return view('frontend.training.training-details');
    }
    ...
    public function trainingDetails($id)
    {
        ...
        return view("frontend.training.training-details", compact('training'));
    }
}

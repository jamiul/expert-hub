...
class ProjectController extends Controller
{
    ...
    public function myRunningProject()
    {
        if (isClient()) {
            ...
            $running_projects = DB::table('projects')
                ...
                ->distinct()
                ->paginate(10);
            return view('frontend.user.expert.projects.my_running_project', compact('running_projects'));
        }
    }
    ...
    public function biddedProjects()
    {
        ...
        return view('frontend.user.expert.projects.bidded', compact('bidded_projects', 'total_bidded_projects'));
    }
    ...
    public function myCancelledProject()
    {
        if (isClient()) {
            ...
            return view('frontend.user.expert.projects.my_cancelled_project', compact('cancelled_projects'));
        }
    }
    ...
    public function myCompletedProject()
    {
        if (isClient()) {
            ...
            return view('frontend.user.expert.projects.my_completed_project', compact('completed_projects'));
        }
    }

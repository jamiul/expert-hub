...
class ScholarshipCategoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.scholarship_module.category.index', compact('categories', 'sortSearch'));
    }
    ...
    public function edit($id)
    {
        ...
        $allCategories = ScholarshipCategory::all();

        return view('admin.scholarship_module.category.edit', compact('cateogry', 'allCategories'));
    }

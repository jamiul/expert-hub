...
class ScholarshipCountryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->has('search')) {
            ...
            $categories = $categories->where('country_name', 'like', '%' . $sortSearch . '%');
        }

        $categories = $categories->paginate(15);

        return view('admin.scholarship_module.country_name.index', compact('categories', 'sortSearch'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.scholarship_module.country_name.edit', compact('level'));
    }

...
class ScholarshipLevelController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->has('search')) {
            ...
            $categories = $categories->where('level_name', 'like', '%' . $sortSearch . '%');
        }

        $categories = $categories->paginate(15);

        return view('admin.scholarship_module.study_level.index', compact('categories', 'sortSearch'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.scholarship_module.study_level.edit', compact('level'));
    }

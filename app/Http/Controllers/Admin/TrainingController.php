...
class TrainingController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->has('search')) {
            ...
            $trainings = Training::with('trainingDates')->orderBy('created_at', 'asc')->get();
        }
    ...
    public function create()
    {
        ...
        $trainingSoftwares = TrainingSoftware::all();
        $languages = Language::all();
        $courseInstructors = getConsultants();

        return view('admin.training_module.training.create', compact('trainingModes', 'trainingSoftwares', 'languages', 'courseInstructors'));
    }

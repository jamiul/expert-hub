...
class ProfileWizard extends Component
{
    ...
    {
        $this->selectedLanguages = $this->profile()->languages()->pluck('name', 'language_id')->toArray();
        $this->selectedExpertises = $this->profile()->expertises()->pluck('name', 'expertise_id')->toArray();

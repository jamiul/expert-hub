...
<body>
    ...
    <div>
        <div class="mx-3 rounded-md my-2 " style="background: #F2F7F2;">
            <div class="row py-2">
                <div class="col-lg-6 mt-4 px-5 review-banner-main">
                    <h3 class=" text-success fre-review-banner-title">Reviews on Scholarship Australia</h3>
                    <p class="fre-review-banner-text">See how clients and talent celebrate their wins and stay accountable for their work together, or join today to make your own connections.</p>
        ...
        <div class=" container-main">
            <h3 class="fre-review-per-week-title">Clients and talent leave each other 20k new reviews per week</h3>
        ...
        <div class=" container-main ">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12">
                    ...
                    <div class="mt-3">
                        <h5 class="fw-bold mb-2 fre-review-they-say-topic">All Specializations</h5>
                        <h5 class="fre-review-they-say-topic ">Development & IT</h5>
                        <h5 class="fre-review-they-say-topic">Design & Creative</h5>
                        <h5 class="fre-review-they-say-topic">Sales & Marketing</h5>
                        <h5 class="fre-review-they-say-topic">Writing & Translation</h5>
                        <h5 class="fre-review-they-say-topic">Admin & Customer Support</h5>
                        <h5 class="fre-review-they-say-topic">Finance & Accounting</h5>
                        <h5 class="fre-review-they-say-topic">Engineering & Architecture</h5>
                        <h5 class="fre-review-they-say-topic">Legal</h5>
                    </div>
                </div>
                <div class="col-lg-8 col-md-8 col-sm-12 fre-review-say-customer">
        ...
        <div class="my-5 py-5" style="background: #F7FAF7;">
            <div class="fre-review-work-done py-3">
            ...
            <div class="bg-white rounded-1  mt-5  fre-review-work-done ">
        ...
        <div class="bg-white container-main">
            <div class="">
                <h3 class="fre-review-explore-worldwide-title">Explore worldwide reviews</h3>
        ...
        <!-- How to get started -->
        <div class="container-main ">
            <h4 class="fre-review-get-started-title">How to get started</h4>

            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link fre-rv-find-work-bar active fs-16  " id="hiring-talent-tab" data-toggle="tab" href="#hiring" role="tab" aria-controls="hiring" aria-selected="true">Hiring talent</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link fre-rv-find-work-bar fs-16" id="finding-work-tab" data-toggle="tab" href="#finding" role="tab" aria-controls="finding" aria-selected="false">Finding work</a>
                </li>
            </ul>

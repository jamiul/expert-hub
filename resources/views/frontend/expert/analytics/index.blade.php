            ...
            <div class="d-flex">
                <div class="aside__wrapp">
                    <div class="pb-4 border-bottom">
                        ...
                        <p class="text-center text-dark fw-medium mb-0">{{ $expert->full_name }}</p>
                        <p class="text-center text-muted fw-normal mb-0 small lh-base">
                            <span class="d-block text-primary">{{ $expertProfile->expertField->name }}</span>
                        </p>
                        <div class="mt-3">
                            <div class="d-flex align-items-center justify-content-center mb-1">
                                ...
                                <span class="text-dark small fw-medium ff-public-sans ps-1">Sydney, {{ $expert->country->name }}</span> 
                            </div>

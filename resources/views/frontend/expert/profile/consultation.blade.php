                                ...
                                <div class="expert-card-body">
                                    ...
                                    <div class="project-expert-summary py-3">
                                        <p>Prof. Michael is an accomplished Curriculum Development Specialist with a
                                            ...
                                            services. Holding a PhD in Curriculum and Instruction, Prof. Michael has
                                            dedicated expertise in designing innovative curricula, enhancing student
                                            engagement, and conducting research on educational best practices particularly
                                            in public health education. With a background in curriculum coordination,
                                            consultation, and a strong commitment to education, Prof. Michael has made
                                            significant contributions to the field. <a href="#"
                                                class="edux-read-more">More</a></p>
                                    </div>
                                        ...
                                        <div class="card card-24 mb-3 border-0">
                                            <div class="card-body pb-0 pt-0">
                                                ...
                                                <p>As a Director of Curriculum Development at the Public Health
                                                    ...
                                                    <span class="edux-more-read"> ... More</span>
                                                </p>
                                            </div>
                ...
                <div class="edux-sidebar-expert edux-billing-method-right-sidebar">
                    ...
                    <div class="eudx-total-slot-area py-1">
                        <ul>
                            ...
                            <li>
                                <span>
                                    <strong class="edux-booking">Booking for 1 hour</strong>
                                </span>
                                <span>
                                    <strong class="edux-booking">${{ $consultation->hourly_rate }}</strong>
                                </span>
                            </li>
                    ...
                    <div class="edux-right-schedule mt-3">
                        ...
                        <div class="form-radio-option edux-radio-option-right">
                            <input type="radio" name="gender" id="Male"
                                class="form-radio-field form-check-input" wire:model="gender" value="male">
                            <label class="form-radio-title  edux-form-radio-title-right me-4" for="Male"> <span
                                    class="me-1 edux-meeting-title"> Meeting now</span>
                        ...
                        <div class="tag-list mt-2">
                            @forelse ($consultation->slots as $slot)
                                <a href="#" class="expert-profile-tag">{{ $slot->time }}</a>
                            @empty
                                <p>No data</p>
                            @endforelse
                        </div>

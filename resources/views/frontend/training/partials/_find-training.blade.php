<div class="find-training find-training-2 databasepading">
    <div class="container">
        <div class="row">
                        ...
                        <div class="accordion">
                            ...
                            <div class="at-item">
                                <div class="at-title">
                                    <h2>
                                        <input type="checkbox" id="0">
                                        <span for="0">HDR Scholarshipss</span>
                                    </h2>
                                </div>
                                <div class="at-tab" style="display: none;">
                                    <ul>
                    ...
                    <div class="study-level study-level-media">
                        ...
                        <ul>
                            <li>
                                ...
                                <label for="71">Live via Zoom</label>
                            </li>
                            <li>
                                <input type="checkbox" id="72">
                                <label for="72">Face-to-Face</label>
                            </li>
                        </ul>
                    </div>
                    <div class="study-level">
                    ...
                    <div class="right-database">
                        ...
                        <div class="database-p">
                            <p>This training will give you a strong working understanding of methods used to design and
                                ...
                                these methods and their limitations... <a href="#">Read More</a></p>
                        </div>
                        <div class="deta-list">
                            <ul>
                                <li>Seminar Dates</li>
                    ...
                    <div class="right-database">
                        <div class="database-block">
                            <div class="database-contant">
                                ...
                                <div class="database-text">
                                    <h4>Multilevel and Mixed Models Using Stata</h4>
                                    <span>Time in United Kingdom (GMT+1)</span>
                                    <span>UK</span>
                                </div>
                            </div>
                            <div class="database-right">
                        ...
                        <div class="database-p">
                            <p>Financial support to cover living costs and tuition for postgraduate research students to
                                work with leading researchers on nationally significant projects that are aligned with
                                recently awarded Category 1 research grants</p>
                        </div>
                        <div class="deta-list">
                            <ul>
                                <li>Seminar Dates</li>
                    ...
                    <div class="right-database">
                        <div class="database-block">
                            <div class="database-contant">
                                ...
                                <div class="database-text">
                                    <h4>Multilevel Modeling: A Second Course</h4>
                                    <span>Chicago (CDT)</span>
                                    <span>USA</span>
                                </div>
                            </div>
                            <div class="database-right">

...
@section('content')
                        ...
                        <div class="mb-4 mt-lg-1 py-lg-4" style="background:#275846">
                            <div class="row rounded-0 px-2 mx-4">
                                <div class="col-lg-12 col-sm-12 my-auto">
                                    <h3 class="text-white fw-700 fs-30  ">Hire the best academic consultants
                                    </h3>
                                    <p class="fw-400 text-white fs-18 mb-2">Boost your academic success with us! Share your project details, browse profiles, chat with academic consultants, and pay only when you're satisfied.
                                    </p>
                                </div>
                    ...
                    <div class="card rounded-2 border-gray-light">
                        ...
                        <div class="card-body">
                            <form class="form-horizontal" action="{{ route('projects.store') }}" method="POST"
                                ...
                                {{-- attachment --}}
                                <div class="form-group">
                                    <label class="form-label fw-700" for="signinSrEmail">{{ translate('File attachment') }}</label>
                                ...
                                <div class="form-group">
                                    <label class="fw-700">
                                        {{ translate('What academic skills is required for this project? ') }}
                                        <span class="text-danger">*</span>
                                    </label>
                                    <label class="pt-0">
                                        {{ translate('List up to 5 key skills that represent your project. Academic consultants will use these skills to match with projects aligned to their interests and expertise.') }}
                                    ...
                                    {{-- <select multiple class="form-control aiz-selectpicker" name="skills[]" required
                                        data-live-search="true" data-placeholder="Select required skills"
                                        data-selected-text-format="value" id="skills">
                                        @foreach ($skills as $skill)
                                            <option value="{{ $skill->id }}">{{ $skill->name }}</option>
                                        @endforeach
                                    </select> --}}
                                ...
                                <div class="form-group">
                                    <div class="form-label mb-2  fw-700">
                                            ...
                                            @if ($client_package->fixed_limit > 0)
                                                <div class="custom-control custom-radio custom-control-inline ">
                                                    ...
                                                    <label class="custom-control-label fw-700 text-black fs-16"
                                                        for="projectTypeFixed">{{ translate('Fixed price') }}
                                                        <p class="fw-500 fs-14">
                                                            {{ translate('Agree on a price upfront, then release payment upon project completion') }}
                                                        </p>
                                                    </label>
                                        ...
                                        <div class="col-lg-4 card py-3 px-2 pl-0">
                                            @if ($client_package->long_term_limit > 0)
                                                <div class="custom-control custom-radio custom-control-inline ">
                                                    ...
                                                    <label class="custom-control-label fw-700 text-black fs-16"
                                                        for="projectTypeLong">{{ translate('Hourly rate') }}
                                                        <p class="fw-500 fs-14">
                                                            {{ translate('Select freelancers based on their hourly rates and pay for the hours worked.') }}
                                                        </p>
                                                    </label>
                                                </div>
                                            @else
    ...
    <script>
        ...
        var lookup = {
            'AUD': ['Basic ($2 - 8 AUD per hour)', 'Moderate ($8 - 15 AUD per hour)',
                'Standard ($15 - 25 AUD per hour)', 'Skilled ($25 - 50 AUD per hour)', 'Expert ($ 50+ AUD per hour)'
            ],
            'USD': ['Basic ($2 - 8 USD per hour)', 'Moderate ($8 - 15 USD per hour)',
                'Standard ($15 - 25 USD per hour)', 'Skilled ($25 - 50 USD per hour)',
                'Expert ($ 50+ USD  per hour)'
            ]
        };

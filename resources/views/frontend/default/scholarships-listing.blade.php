    ...
    <div class="row">
      <div class="col-xl-8 offset-xl-2 text-center">
        <h1 class="h5 mt-3 mt-lg-0 mb-5 fw-400">{{ translate('Total') }} <span class="fw-600">{{ $total }}</span>
          {{ translate('projects found for') }} <span class="fw-600">{{ $keyword }}</span></h1>
      </div>
    </div>
    @endif
            ...
            <div class="card rounded-0 border-0 collapse-sidebar c-scrollbar-light shadow-none">
              ...
              <div class="mb-5">
                ...
                <div class="aiz-radio-list">
                  ...
                  <label class="aiz-radio">
                    <input type="radio" name="bids" value="10-20" onchange="applyFilter()" @if ($bids=="10-20" ) checked
                      @endif> {{ translate('10 to 20') }}
                    <span class="aiz-rounded-check"></span>
                    <span class="float-right text-secondary fs-12"></span>
                  </label>
                  <label class="aiz-radio">
                    <input type="radio" name="bids" value="20-30" onchange="applyFilter()" @if ($bids=="20-30" ) checked
                ...
                <div class="row mt-2">
                  <div class="col-6">
                    <span class="range-slider-value value-low fs-14 fw-600 opacity-70" @if (isset($min_price))
                      data-range-value-low="{{ $min_price }}" @elseif(count($projects)> 1 && $projects->min('price') >
                      0)
                  ...
                  <div class="col-6 text-right">
                    <span class="range-slider-value value-high fs-14 fw-600 opacity-70" @if (isset($max_price))
                      data-range-value-high="{{ $max_price }}" @elseif(count($projects)> 1 && $projects->max('price') >
                      0)
        ...
        <div class="card mb-lg-0 rounded-2 border-gray-light">
          ...
          <div class="card-body p-0">
            ...
            <a href="{{ route('project.details', $project->slug) }}"
                ...
                <ul class="list-inline opacity-70 fs-12">
                  ...
                  <li class="list-inline-item">
                    ...
                    <span class="ml-1">@if ($project->project_category != null) {{ $project->project_category->name }}
                      @else {{ translate('Removed Category') }} @endif</span>
                  </li>
                </ul>
                <div>
              ...
              <div
                class="border-lg-left border-gray-light flex-shrink-0 pt-4 pt-xl-0 pl-xl-4 d-flex flex-row-reverse flex-xl-column justify-content-between align-items-center align-items-xl-start minw-130px">

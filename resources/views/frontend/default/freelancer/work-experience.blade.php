        ...
        <div class="mb-4 border-bottom pb-3">
            <div class="">
                ...
                <h6 class="fs-16"><span class="text-muted"><i>{{ $user_work_exp->location }}</i></span> |
                    <span class="fw-700">{{ $user_work_exp->start }} - {{ ($user_work_exp->present == '1') ? translate('Present') : $user_work_exp->end }}</span>
                </h6>
            </div>
            <h6 class="fs-16 mt-3" style="line-height:26px;">{{ $user_work_exp->description }}</h6>
        </div>
    @endforeach
</div>

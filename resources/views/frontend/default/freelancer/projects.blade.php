...
<div class="rounded border mt-4 mx-lg-4">
    <div class="d-flex align-items-center px-3">
        <img src=" {{ asset('/assets/home/find-scholarship/project.png') }}" class="testimonals-icon" alt="service_image">
        <ul class="nav nav-tabs freePage-work-history-com-prog" id="myTab" role="tablist">
            <li class="nav-item">
                <a class="nav-link  fs-23 fw-700 testimonals" id="finding-work-tab" data-toggle="tab" href="#finding"
                    role="tab" aria-controls="finding" aria-selected="false">Current Projects</a>
            </li>
            <span class="mt-3">|</span>
            <li class="nav-item">
                <a class="nav-link show active fs-23  fw-700 testimonals" id="hiring-talent-tab" data-toggle="tab"
    ...
    <div class="tab-content" id="myTabContent">
        <div class="tab-pane fade " id="hiring" role="tabpanel" aria-labelledby="hiring-talent-tab">
            <div class="tab-pane fade show active" id="finding" role="tabpanel" aria-labelledby="finding-work-tab">
                <div class=" mb-3  p-2 px-3">
                    <div class="border-bottom pb-3">
                        <div class="">
                            ...
                            <h6 class="fs-16 "><span class="text-muted"><i>Public Health Institute of Sydney, Sydney,
                                        Australia </i></span> |
                                <span class="fw-700">2018-2022</span>
                            </h6>

                        </div>
                        <div class="fs-16 mt-3  current-project ">
                            <h6 class="fs-16 mb-0 current-project my-2">I led a groundbreaking project in
                ...
                <div class=" mb-2 p-2 px-4">
                    <div class="">
                        ...
                        <h6 class="fs-16 "><span class="text-muted">
                                <i>International Public Health Education Consortium </i></span> | <span class="fw-700">
                                2018-2022</span></h6>
        ...
        <div class="tab-pane fade show active" id="finding" role="tabpanel" aria-labelledby="finding-work-tab">
            <div class=" mb-3  p-2 px-3">
                <div class="border-bottom pb-3">
                    ...
                    <div class="fs-16 mt-3 current-project">
                        ...
                        <h6 class="fs-16 mb-0  my-2 current-project">I led a groundbreaking project in
            ...
            <div class=" mb-2 p-2 px-3">
                <div class="">
                    ...
                    <h6 class="fs-16 "><span class="text-muted"><i>International Public Health Education Consortium
                            </i></span> | <span class="fw-700"> 2018-2022</span></h6>
                ...
                <div class="fs-14 mt-1 mb-0  ">
                    ...
                    <h6 class="fs-16 mb-0  my-3">In this role, I
                        contributed to the advancement of public health education and
                        curriculum development by:</h6>
                    <h6 class="fs-16 mb-0  my-2 current-project">

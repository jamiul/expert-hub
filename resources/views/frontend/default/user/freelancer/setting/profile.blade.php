                    ...
                    <div class="card-body">
                        <form action="{{ route('user_profile.verification_store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mt-4 text-right">
                                <!-- Buttons -->
                                <button type="submit" class="btn btn-primary rounded-1">{{ translate('Save Changes') }}</button>
                                <!-- End Buttons -->
                            </div>
                        </form>
                    </div>
                        ...
                        <form class="js-validate" action="{{ route('user_profile.basic_info_update') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <select class="form-control aiz-selectpicker" name="city_id" id="city_id" data-msg="Please select your city." data-live-search="true">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-control aiz-selectpicker country-flag-select" id="nationality" name="nationality" required data-live-search="true">
                                        ...
                                        <option value="{{ pathinfo($path)['filename'] }}" data-content="<div class=''><img src='{{ my_asset('assets/frontend/default/img/flags/' . pathinfo($path)['filename'] . '.png') }}' height='11' class='mr-2'><span>{{ strtoupper(pathinfo($path)['filename']) }}</span></div>" @if ($user_profile->nationality == pathinfo($path)['filename'])
                                            selected
                                            @endif
                                            ></option>
                                        @endforeach
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('user_profile.portfolio_add') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="portfolio_name" placeholder="{{ translate('Portfolio title') }}">
                            </div>
                            <div class="form-group">
                                <label id="usernameLabel" class="form-label">{{ translate('Category') }}<span class="text-danger">*</span></label>
                                <input type="text" class="form-control" name="portfolio_category" placeholder="{{ translate('Portfolio Category') }}">
                            </div>
                            <div class="form-group">
                                <label id="usernameLabel" class="form-label">{{ translate('Details') }}<span class="text-danger">*</span></label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="mt-2 text-right">
                                    <!-- Buttons -->
                                    <button type="submit" class="btn btn-primary rounded-1">{{ translate('Add Portfolio') }}</button>
                                    <!-- End Buttons -->
                                </div>
                            </div>
                        </form>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('user_profile.work_experience_add') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="company_name" placeholder="{{ translate('Company Name') }}" required>
                            </div>
                            <div class="form-group">
                                <label>{{ translate('Joining date') }} <span class="text-danger">*</span></label>
                                <input type="text" class="aiz-date-range form-control" name="start_date" placeholder="{{ translate('Select Date') }}" data-single="true" data-show-dropdown="true" autocomplete="off" />
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group leaving-date">
                                ...
                                <input type="text" class="aiz-date-range form-control" name="end_date" placeholder="{{ translate('Select Date') }}" data-single="true" data-show-dropdown="true" autocomplete="off" />
                            </div>
                            <div class="form-group">
                                <label id="usernameLabel" class="form-label">{{ translate('Company Website') }}</label>
                                <input type="text" class="form-control" name="company_website" placeholder="{{ translate('Company Website') }}">
                            </div>
                            <div class="form-group">
                                <label id="usernameLabel" class="form-label">{{ translate('Designation') }}<span class="text-danger">*</span></label>
                                <input type="text" class="form-control" name="designation" placeholder="{{ translate('Designation') }}" required>
                            </div>
                            <div class="form-group">
                                <label id="usernameLabel" class="form-label">{{ translate('Description
...
') }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="location" placeholder="{{ translate('Company Location') }}" required>
                            </div>
                            <div class="mt-2 text-right">
                                <!-- Buttons -->
                                <button type="submit" class="btn btn-primary rounded-1">{{ translate('Add Work Experience') }}</button>
                                <!-- End Buttons -->
                            </div>
                        </form>
                        @else
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('user_profile.education_info_add') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="school_name" placeholder="{{ translate('School Name') }}" required>
                            </div>
                            <div class="form-group">
                                <label id="usernameLabel" class="form-label">{{ translate('Degree') }}<span class="text-danger">*</span></label>
                                <input type="text" class="form-control" name="degree" placeholder="{{ translate('Ex. Bachelor of Science') }}" required>
                            </div>
                            <div class="form-group">
                                ...
                                <div id="datepickerWrapperFrom" class="js-focus-state u-datepicker input-group">
                                    <input type="number" class="form-control" name="passing_year" placeholder="{{ translate('Ex. 2008') }}" required>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="mt-2 text-right">
                                <!-- Buttons -->
                                <button type="submit" class="btn btn-primary rounded-1">{{ translate('Add Education Information') }}</button>
                                <!-- End Buttons -->
                            </div>
                        </form>
                    </div>

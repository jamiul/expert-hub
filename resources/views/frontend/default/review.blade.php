                            ...
                            <div class="col-lg-3 col-md-6 col-sm-12">
                                <div class=" shadow-sm " style="background: #F2F7F2;">
                                    <div class="px-3 py-2">
                                        ...
                                        <p class="review-hf-card-text">Choose how you get paid. Our fixed-price protection releases client payments at project milestones. Hourly protection bills clients every week. However you work, our service fees are the same. Spend less time chasing, more earning.</p>
                                    </div>
                                </div>
            ...
            <div class="container-main-powerful  rounded-2" style="background: #1F57C3;">
                <div class="row mx-2 py-3">
                    <div class="col-lg-4 col-sm-12">
                        <img class="img-fluid rounded-2" src="{{my_asset('powerful-relationship.jpg')}}" alt="" style="height:300px; ">
                    </div>
                    <div class="col-lg-8 col-sm-12 position-relative ">
                        ...
                        <div class="find-job-banner-rating-section">
                            <div class="border-bottom border-white mt-5"></div>
                            <div class="row mt-4 ">

                                <h5 class="col-lg-8 text-white  fs-16px">Join the world’s work marketplace and get work done, your way. </h5>
                                <div class=" col-lg-4  border border-white rounded-2 join-scholarship-btn  ">
                                    <p class="text-white fs-14px ">Join scholarship australia</p>
                                </div>
                            </div>
                        </div>
                    </div>

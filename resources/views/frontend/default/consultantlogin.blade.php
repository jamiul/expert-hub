                            ...
                            <div class="card-body my-auto">
                                <div class="custom-input-group first-input my-auto">
                                    <div class="mb-2 p-4 typetab selected-tab">
                                        <img class="icon" src="{{ asset('assets/frontend/default/img/experticon.png') }}"
                                            alt="Edu Expert" />
                                ...
                                <div class="custom-input-group mt-3">
                                    <div class="mb-2 p-4 typetab">
                                        <img class="icon" src="{{ asset('assets/frontend/default/img/usericon.png') }}"
                                            alt="Edu Client" />
                                        <span class="bold-text">I'm a Client</span>
                                        <input type="radio" name="usertype" id="usertype" value="client">
                                    </div>
                                </div>
                                <button type="button" class="w-100 btn btn-lg btn-primary mt-3 btn-join">Join as an Edu
                                    Expert</button>
                            </div>
                            <div class="text-center">
                                <p class="text-muted mb-0">Already have an account, <a href="#">Sign In</a></p>
                            </div>
                        </div>
                    </form>
                </div>

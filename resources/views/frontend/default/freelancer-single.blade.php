                    ...
                    <div class=" freePage-sign-login-btn-show" >
                        <div class="py-2 px-4">
                            <div class="d-flex flex-column">
                                <p class="fs-14 fw-600 text-black text-center mb-0 py-2">Ready to work with {{ $freelancer->name }}</p>

                                <div class="d-flex align-items-center justify-content-between">
                                <div class="hire-button  ">
                                    <a href="{{ route('login') }}" class="hire-link">Log in</a>
                                </div>
                                <div class="freePage-invite-button-for-responsive">
                                    <a class="btn text-white fw-600 fs-14" style=" padding: 6px 35px;" href="{{ route('register') }}">Sign up</a>
                                </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="mx-4 d-flex align-items-center mt-2  mb-3">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-left mt-5" aria-labelledby="menuDropdown">
                                            <a class="dropdown-item selected fs-14 fw-500 text-dark" href="#" id="newest">Newest first</a>
                                            <a class="dropdown-item  fs-14 fw-500 text-dark" href="#" id="highest">Highest rated</a>
                                            <a class="dropdown-item fs-14 fw-500 text-dark" href="#" id="lowest">Lowest rated</a>
                                            <a class="dropdown-item fs-14 fw-500 text-dark" href="#" id="largest">Largest projects</a>
                                        </div>
                                    </div>
                                </div>

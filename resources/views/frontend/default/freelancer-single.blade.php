                ...
                <div class="container rounded-1 mt-5">
                    <div class="">
                        <div class="row">
                            ...
                            <div class="col-lg-8 col-xl-9 col-12 pl-lg-3 mt-lg-0  mt-3">
                                <div class=" m-0 p-0 ">
                                    {{-- Biography  --}}
                                    <section>
                                        <div class="tab-content mx-lg-4 w-100 rounded border mb-4 px-lg-2 "
                                            id="nav-tabContent">
                                            <div class="tab-pane fade show active mt-4 px-3" id="list-home"
                                                ...
                                                <div class="mt-3">
                                                    <p class="fs-16  biography-info">Prof. Michael is an
                                                        accomplished
                                                        Curriculum
                                                        Development Specialist with a distinguished career in education and
                                                        a
                                                        ...
                                                        dedicated expertise in designing innovative curricula, enhancing
                                                        student
                                                        engagement, and conducting research on educational best practices.
                                                        With
                                                        ...
                                                        Professional memberships, and awards, making them a prominent figure
                                                        in
                                                        curriculum development, education research, and consultation
                                                        services.
                                                    </p>
                                                </div>
                                            </div>
                                    ...
                                    <section>
                                        <div class="mx-lg-4 rounded border mb-4 p-4">
                                            <h4 class="fw-600 fs-19 text-black expert-singel-profile mb-2">Book Expert for
                                                Consultation </h4>
                                            <div class="row">
                                ...
                                <section>
                                    <div class="mx-lg-4 rounded border p-3">
                                        ...
                                        <div class=" mb-4 border-bottom pb-3">
                                            ...
                                            <h6 class="fs-16 mb-0  ">
                                                Collaborating with faculty members to design and implement innovative
                                                curricula
                                                for undergraduate and graduate programs in public health.</h6>
                                            <h6 class="fs-16  mb-0  my-2 ">
                                                Conducting ongoing research to identify emerging trends and best practices
                                                in
                                        ...
                                        <div class=" mb-4 pb-3 border-bottom">
                                            <div class="">
                                                ...
                                                <h6 class="fs-16 "><span class="text-muted"><i>Lead Researcher in Public
                                                            Health Education</i></span> | <span
                                                        class="fw-700">2010-2015</span>
                                                </h6>
                                            </div>
                                            <h6 class="fs-16 mt-3   " style="line-height:26px;">
                                                In this role, I contributed to the advancement of public health education
                                                and
                                ...
                                <section>
                                    <div class="rounded border mt-4 mx-lg-4">
                                        <div
                                            class="d-flex align-items-center expert-singel-profile  px-lg-3">
                                                    ...
                                                    <div class=" mb-3  p-2 px-3">
                                                        <div class="border-bottom pb-3">
                                                            <div class="">
                                                                ...
                                                                <h6 class="fs-16 "><span class="text-muted"><i>Public
                                                                            Health
                                                                            Institute of Sydney, Sydney, Australia
                                                                        </i></span> |
                                                                    <span class="fw-700">2018-2022</span>
                                                                </h6>

                                                            </div>
                                                            <div class="fs-16 mt-3   " style="line-height:26px;">

                                                                <h6 class="fs-16 mb-0  my-2" style="line-height:26px;">I
                                                                    led a groundbreaking project in
                                                                    collaboration with Public Health Institute of Sydney to
                                                                    develop an innovative public health curriculum. This
                                                                    project
                                                                    aimed to revamp the university's existing curriculum to
                                                                    align with the latest research, pedagogical trends, and
                                                                    industry demands. Key highlights of this project
                                                                    included:
                                                                </h6>
                                                                ...
                                                                <h6 class="fs-16 mb-0  my-2">Collaborating
                                                                    ...
                                                                    competency-based curriculum that emphasised practical
                                                                    skills
                                                    ...
                                                    <div class=" mb-2 p-2 px-4">
                                                        <div class="">
                                                            ...
                                                            <h6 class="fs-16 "><span class="text-muted"><i>International
                                                                        Public Health Education Consortium </i></span> |
                                                                <span class="fw-700"> 2018-2022</span></h6>

                                                        </div>
                                                        <div class="fs-14 mt-1 mb-0  ">

                                                            <h6 class="fs-16 mb-0  my-3">In this role, I
                                                                contributed to the advancement of public health education
                                                                and
                                                                curriculum development by:</h6>
                                                            <h6 class="fs-16 mb-0  my-2" style="line-height:26px;">
                                                                Collaborating with a diverse team of
                                                                ...
                                                                approaches, and assessment methods to identify
                                                                commonalities,
                                                                differences, and best practices.
                                                                Conducting surveys and interviews with faculty members and
                                                                students to gather qualitative insights into the
                                                                effectiveness
                                                ...
                                                <div class=" mb-3  p-2 px-3">
                                                    <div class="border-bottom pb-3">
                                                        ...
                                                        <div class="fs-16 mt-3   " style="line-height:26px;">
                                                            ...
                                                            <h6 class="fs-16 mb-0  my-2" style="line-height:26px;">I led a
                                                                groundbreaking project in
                                                                collaboration with Public Health Institute of Sydney to
                                                                develop
                                                                an innovative public health curriculum. This project aimed
                                                                to
                                                                revamp the university's existing curriculum to align with
                                                                the
                                                                latest research, pedagogical trends, and industry demands.
                                                                Key
                                                                highlights of this project included:</h6>
                                                            <h6 class="fs-16 mb-0  my-2 ">Conducting a
                                                                comprehensive needs assessment to identify gaps in the
                                                                current
                                                                curriculum and the evolving requirements of the public
                                                                health
                                                                field.</h6>
                                                            <h6 class="fs-16 mb-0  my-2">Collaborating with
                                                                a team of subject matter experts to design a
                                                                competency-based
                                                ...
                                                <div class=" mb-2 p-2 px-3">
                                                    ...
                                                    <div class="fs-14 mt-1 mb-0  ">
                                                        ...
                                                        <h6 class="fs-16 mb-0  my-2" style="line-height:26px;">
                                                            ...
                                                            Evaluating curriculum structures, content, pedagogical
                                                            approaches,
                                                            and assessment methods to identify commonalities, differences,
                                                            and
                                                            best practices.
                                                            Conducting surveys and interviews with faculty members and
                                                            students
                                                                ...
                                                                <div class="py-3">
                                                                    <div>
                                                                        ...
                                                                        <p class="  fw-600 fs-16"
                                                                            ...
                                                                            Comparative Analysis of Public Health Curriculam
                                                                        </p>
                                ...
                                <section>
                                    <div class="mx-lg-4 rounded border p-2 px-4 mt-3 mb-3">
                                        ...
                                        <div class=" mb-3 ">
                                            <p class="fs-16"><i>Prof. Michael Kassiou played a pivotal role in the
                                                    development
                                                    of our university curriculum. His expertise, creativity, and dedication
                                                    to
                                                    ensuring our program met the highest standards were truly outstanding.
                                                    We
                                                    are grateful for his contributions and highly recommend his services to
                                                    any
                                            ...
                                            <div class="mt-4">
                                                <p class="fs-16"><i>We are immensely grateful to Prof. Michael Kassiou for
                                                        his
                                                        invaluable assistance in our university's accreditation process His
                                                        deep
                                                        knowledge of accreditation standards and guidance were instrumental
                                                        in
                                                ...
                                                <p class="text-center text-primary fs-16 fw-700"><u> More Testimonals ></u>
                                                </p>

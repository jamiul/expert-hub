...
<div class="whyFreeEdu-container-main">
    <div class=" rounded-md my-2 " style="background: #F2F7F2;">
        <div class="row py-2">
            <div class="col-lg-6 mt-4 px-5 review-banner-main">
                <h1 class="explore-find-oppor-title text-success">Why ConsultantEdu?</h1>
                ...
                <button class="  text-white fs-16 btn btn-primary  px-3 py-2">Join cunsultantEdu</button>
            </div>
    ...
    {{--How ConsultantEdu works--}}
    <div class=" " style="width: 80% ;margin:100px 10%; ">
        <div class="">
            <button class="btn btn-primary text-white mx-auto rounded-0 d-flex justify-content-center py-3 px-5 fs-18" href="#">How ConsultantEdu works</button>
            <div class="row mt-3 ">
    ...
    {{-- Consultants – find the right work for you --}}
    <div class="my-5" id="consultantsSection">
        <h1 class="explore-find-oppor-title text-success">{{translate('Consultants – find the right work for you')}}</h1>
    ...
    <div class="my-5" id="clientSection">
        <h1 class="explore-find-oppor-title text-success">Clients – find the best consultant for you
        </h1>
        <div class="row ">
            <div class="col-lg-5 col-sm-12 ">
                <h4 class="explore-find-oppor-title">{{translate('Let the work find you')}}</h4>
    ...
    <div class="my-5" id="reviewSection">
        <h1 class="explore-find-oppor-title text-success ">{{translate('Reviews – how reviews work on ConsultantEdu')}}</h1>
       <div class="row">
        <div class="col-lg-6">
             {{-- Consultants - Getting reviews on ConsultantEdu --}}
        <div class="mt-2">
            <p class="fs-16 fw-700">Consultants - Getting reviews on ConsultantEdu
            </p>
        ...
        <div class="mt-2">
            <p class="fs-16 fw-700">Clients - Leaving a review on ConsultantEdu
            </p>
            ...
            <p class="fw-700 fs-14">Example</p>
        </div>
        </div>
        <div class="col-lg-6">
            <img src="{{my_asset('assets/frontend/default/img/whyScholarship/review.jpeg')}}" alt="">
        </div>
       </div>
        ...
        <div class="mt-5" >
            <h1 class="explore-find-oppor-title">Contesting a review on ConsultantEdu</h1>
        ...
        <div class="mt-1">
            <h1 class="explore-find-oppor-title">Checking your reviews on ConsultantEdu</h1>
        ...
        {{-- FAQS --}}
        <div class="my-5" id="FAQs">
            <h1 class="explore-find-oppor-title text-success">FAQS</h1>

            <ul class="nav " id="myTab" role="tablist">
                <li class="nav-item">
                    <a class=" active fs-16 mr-2  pr-2 " style="border-right:2px solid; color:black !important; black" id="for-consultants" data-toggle="tab" href="#consultant" role="tab" aria-controls="consultant" aria-selected="true">For Consultants</a>
                </li>
                <li class="nav-item">
                    <a class=" fs-16 mr-2  pr-2" id="for-client" data-toggle="tab" href="#client"   style="border-right:2px solid; color:black !important; black"  role="tab" aria-controls="client" aria-selected="false"> For clients </a>
                </li>
                <li class="nav-item">

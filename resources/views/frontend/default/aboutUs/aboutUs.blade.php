...
@section('content')
    ...
    <div class="whyFreeEdu-container-main mb-5 " style="background-color:#F2F7F2">
        <section>
            @include('frontend.default.aboutUs.about-eduExHub')
        </section>
        <hr>
        <section class="">
            @include('frontend.default.aboutUs.make-impressive')
        </section>
        <hr>
        {{-- EduExperts – find the right work for you --}}
        <section>
            @include('frontend.default.aboutUs.eduExpert-steps')

        </section>
        {{-- Clients – find the best client for you --}}
        @include('frontend.default.aboutUs.client-steps')
        <hr>

        {{-- Reviews – how reviews work on EduExHub --}}
        @include('frontend.default.aboutUs.reviews')
        {{-- FAQS --}}
        @include('frontend.default.aboutUs.faq')

                        ...
                        <div class="menu pr-2">
                            <nav class="navbar-expand">
                                <ul class="navbar-nav ml-auto align-items-center">
                                    ...
                                    <li class="nav-item ml-xl-3">
                                        <a class="btn text-white " style="background-color:#275846;" href="{{ route('register') }}">{{ translate('Post a Project') }}</a>
                                    </li>
                                    @elseif (isAdmin())
                                    <li class="nav-item d-none d-lg-block">
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse px-3" id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav ml-auto ps-lg-0 " style="padding-left: 0.15rem">
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-white" href="{{ url('/search?keyword=&type=freelancer') }}">{{ translate('Find Academic Work') }}</a>
                            </li>

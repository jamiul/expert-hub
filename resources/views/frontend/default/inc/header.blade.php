...
<header class="aiz-header bg-white @if(get_setting('header_stikcy') == 'on') sticky-top @endif">
  <div class="aiz-navbar py-0px fs-14 position-relative">
    <div class="container-fluid py-14px px-lg-5 d-none d-md-block">
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                          ...
                          <div class="col-4 p-0">
                            <a href="{{ route('register') }}?type=2"
                              class="py-3 px-1 text-dark">{{ translate('I want to Hire') }}</a>
                            <a href="{{ route('register') }}?type=1"
                              class="py-3 px-1 text-dark">{{ translate('I want to Work') }}</a>
                          </div>
                          @else
                          <div class="logo">
                            <a href="{{ route('home') }}" class="d-inline-block">
                              <img
                                src="{{ custom_asset(\App\Utility\SettingsUtility::get_settings_value('system_logo_black')) }}"
                                height="" class="mh-40px w-100">
                            </a>
                          </div>
                          @endif
                              ...
                              <div class="front-header-search d-flex align-items-center bg-white px-3 px-lg-0">
                                ...
                                <form action="{{ route('search') }}" method="GET" class="flex-grow-1">
                                  <div class="input-group">
                                    ...
                                    <select class="form-control aiz-selectpicker  rounded-left-0" name="type">
                                      <option value="freelancer" @isset($type) @if ($type=='freelancer' ) selected
                                        @endif @endisset>{{ translate('Freelancers') }}</option>
              ...
              <nav class="navbar navbar-expand-lg ">
                <div class="collapse navbar-collapse" id="navbarNav">
                  <ul class="navbar-nav">
                      ...
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                          <a class="dropdown-item"
                            href="{{route('waysToEarn')}}">{{ translate('Find ways to earn') }}</a>
                          <a class="dropdown-item pe-2"
                            href="{{route('promote')}}">{{ translate('Find ways to promote yourself') }}</a>
                          <a class="dropdown-item"
                            href="{{ route('skills')}}">{{ translate('Find work for your skills') }}</a>
                        </div>
                      </div>
                    ...
                    <li class="nav-item">
                      <a class="nav-link text-white " href="#">{{ translate('About Us') }}</a>
                    </li>
                  </ul>
                </div>
              </nav>

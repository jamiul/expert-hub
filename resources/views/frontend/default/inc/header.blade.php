                ...
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="logo ml-4 ">
                        <a href="{{ route('home') }}" class="d-inline-block">
                            <img src="{{ custom_asset(\App\Utility\SettingsUtility::get_settings_value('system_logo_black')) }}" height="" class=" w-100" style="max-height:30px;">
                        </a>
                    </div>
                    @endif
                        ...
                        <div class="menu pr-2">
                            <nav class="navbar-expand">
                                <ul class="navbar-nav ml-auto align-items-center">
                                    ...
                                    <li class="nav-item ml-xl-3">
                                        <a class="btn text-white " style="background-color:#275846;" href="{{ route('register') }}">{{ translate('Post a Job') }}</a>
                                    </li>
                                    @elseif (isAdmin())
                                    <li class="nav-item d-none d-lg-block">
...
=======
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-white" href="{{ url('/search?keyword=&type=project')}}">{{ translate('Find Job') }}</a>
                            </li>

                            <!-- <li class="dropdown mega_menu nav-item">
>>>>>>> 3710853b4ec759f1a8471451b90727a30c0e7109
...
=======
                            <li class="nav-item">
                                <a class="nav-link text-white" href="{{ route('scholarshipSearch')}}?keyword=&type=scholarships">{{ translate('Find Scholarships') }}</a>
                            </li>

        ...
        <div class="row">
          <div class="col-xl-6 col-sm-6">
            <div class="aiz-front-widget d-inline-block d-md-block mb-4">
              <h4 class="title text-white">{{ translate('Subscription') }}</h4>
          ...
          <div class="col-xl-3 col-sm-6">
            <div class="aiz-front-widget mb-5">
              <h4 class="title text-white">{{ get_setting('social_widget_title') }}</h4>
          ...
          <div class="col-xl-3 col-sm-6">
            <div class="aiz-front-widget mb-5">
              <h4 class="title text-white">{{ translate('Mobile Apps') }}</h4>
              <ul class="list-inline apps">
                @if (!empty(get_setting('app_link_android')))
                <li class="list-inline-item">
                  <a href="{{ get_setting('app_link_android') }}" target="_blank" class="facebook"><i
                      class="lab la-android"></i></a>
                </li>
                @endif
                @if (!empty(get_setting('app_link_apple')))
                <li class="list-inline-item">
                  <a href="{{ get_setting('app_link_apple') }}" target="_blank" class="twitter"><i
        ...
        <div class="row align-items-center">
          ...
          <div class="col-6 text-right">
            <div class="dropdown dropup d-inline-block ml-auto">
              ...
              @endphp
              @if ($lang != null)
              <a class="dropdown-toggle text-white no-arrow py-2" data-toggle="dropdown" href="javascript:void(0);"
  ...
  <div class="d-flex justify-content-around align-items-center">
    ...
    <a href="javascript:void(0)" class="text-reset flex-grow-1 mobile-side-nav-thumb pb-2 pt-3 text-center"
      ...
      <span class="d-block mx-auto">
        ...
        @else
        <img src="{{ my_asset('assets/frontend/default/img/avatar-place.png') }}" class="rounded-circle size-20px">
        @endif

        ...
        <div class="col-xl-9 col-lg-8 ">
          <div class="card mb-lg-0 border-0">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
              <div>
                <p class="fw-500 fs-15 text-black mb-0"> <span
                    class="text-black fw-600 fs-15">{{ $projects->count()}}</span> project available</p>
              </div>
              <div class="d-flex  ">
            ...
            <div class="mt-2 d-flex justify-content-center mx-0">
              <h5 class="fs-15 fw-500 text-black"> {{$projects->count()}} of {{$projects->total()}} projects available
              </h5>
            </div>
          </div>
        </div>

  ...
  <div class="mx-3 rounded-md my-2 " style="background: #F2F7F2;">
    <div class="row py-2">
      <div class="col-lg-6 mt-4 px-5 review-banner-main">
        ...
        <p class="fre-review-banner-text">Stand out from the competition and get more control over your chances of winning
          the work you want.</p>

        <button class="  text-white fs-16 btn btn-primary  px-3 py-2">Find work</button>
      </div>
      <div class="col-lg-6  py-2 px-5">
        <img src=" {{url('/public/assets/findJob/promote-1.jpg')}}" alt="Image" class=" w-100 p-2 rounded-2" style=" height:350px;" />
      </div>
    </div>
  </div>
    ...
    <div class="row pt-5 d-flex justify-content-between">
      <div class="col-lg-6">
        <div>
          ...
          <p class="text-justify fre-review-banner-text">
      ...
      <div class=" row  pb-3">
        <div class=" col-lg-6 col-sm-12">
          <div class="card rounded-2 bg-white h-100">
            <div class="card-body">
              ...
              <div class="card-body rounded-2 " style="background-color:#91E6B3"><img class="mx-auto d-block " src=" {{url('/public/assets/findJob/jobs-1.png')}}" alt="Image" style="width:120px; align-items:center;
                  " /></div>
              ...
              <p class="btn btn  mt-2" style="background-color:#275846;"><a class="text-white" href="{{route('badge')}}">Learn
                  more</a> </p>
            </div>
          </div>
        </div>
        <div class="col-lg-6 col-sm-12">
          <div class="card bg-white h-100 rounded-2">
            <div class="card-body">
              <div class="card-body  rounded-2" style="background-color:#91E6B3"><img class="mx-auto d-block" src=" {{url('/public/assets/findJob/jobs-2.png')}}" alt="Image" style="width:120px; align-items:center;
                  " /></div>
              ...
              <p class="btn btn  mt-2 " style="background-color:#275846;"><a class="button-color text-white" href="{{route('proposal')}}">Learn
                  more</a> </p>
            </div>
          </div>
        </div>

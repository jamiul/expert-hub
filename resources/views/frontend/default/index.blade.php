        ...
        <div class="d-lg-flex d-md-flex justify-content-around  align-items-center">
          <div class="row justify-content-between px-4 p-3 " style="width:50%;">
            <div class="">
              ...
              <p class="fs-15 my-3 banner ">Millions of people use scholarships Australia to turn their ideas into
                reality.
              </p>
              <div>
              ...
              <div class="">
                ...
                <div class="card-body">
                  <div>
                    ...
                    <p class="card-title mt-1 fs-16 fw-700">I will design fully responsive website website with HTML,
                      CSS,
                      boootstrap..
                    </p>
                    <span>

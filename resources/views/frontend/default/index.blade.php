                                    ...
                                    <div class="row">
                                        <div class="col-lg-10 col-sm-12 home-cacap-head">
                                            ...
                                            <p class="fs-20 fs-sm-14 mt-4 mb-5 ">ConsultantEdu Hub is an exclusive platform
                                                featuring top academic experts across diverse fields. Whether it's a
                                                personal or institutional project or media interviews, our pool of top
                                                academic experts is here to assist.</p>
                ...
                <div class="mt-5 pb-2">
                    <div class="">
                        <div class=" content-title  text-center pb-5 pt-3">
                            <h2 class="fw-700 fs-36 text-white mb-3">Navigating top Academic Expert Made Easy
                            </h2>
                            <p class="fw-700 fs-20 text-white mb-3 main-content">We are the largest, globally connected
                                network of top academic talent, and we're prepared to tackle your most critical projects.
                            </p>
                        </div>
                        ...
                        <div class="d-flex justify-content-between ">
                            <div class="w-lg-75w-lg-75 lh-1-8 content-title ">
                                ...
                                <h2 class="fw-700 fre-small-font text-success">
                                    Browse academic consultants by category
                                </h2>
                    ...
                    <div class="container-home">
                        <div class="d-flex justify-content-between ">
                            <div class="w-lg-75 w-xl-50 lh-1-8 content-title ">
                                <!-- <h2 class="fw-700 fs-40">{{ get_setting('service_section_title') }}</h2> -->
                                <h2 class="fw-700 fre-small-font text-success">
                                    Search academic projects by category
                                </h2>
                                <!-- <p class="fs-18">{{ get_setting('service_section_subtitle') }}</p> -->
                            </div>
                            <div>
                                            ...
                                            <div class="col-11 pl-0">
                                                <div class=" border-bottom">
                                                    ...
                                                    <p class="frequently-qsn-details text-justify">
                                                        ConsultantEdu takes pride in its extensive and diverse network of
                                        ...
                                        <div class="row mt-1">
                                            ...
                                            <div class="col-11 pl-0">
                                                <div class=" border-bottom">
                                                    ...
                                                    <p class="frequently-qsn-details text-justify">
                                                        ConsultantEdu offers an array of comprehensive services designed to
                                                        meet a wide spectrum of needs. Whether users are embarking on course
                                        ...
                                        <div class="row mt-1">
                                            ...
                                            <div class="col-11 pl-0">
                                                <div class=" border-bottom">
                                                    ...
                                                    <p class="frequently-qsn-details text-justify">
                                                        Security is paramount at ConsultantEdu. To guarantee peace of mind
                                                        for both users and experts, we hold payments in escrow until

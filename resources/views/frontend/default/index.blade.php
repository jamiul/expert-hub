                            ...
                            <div class="row">
                                <div class="col-lg-7 col-sm-12 home-cacap-head">
                                    ...
                                    <div class="lg-my-3 my-sm-0 home-banner-button ">
                                        <a href="{{route('register') }}?type=2" class="btn text-white fw-700  fs-lg-18 fs-sm-12 py-lg-3 py-sm-1 px-lg-5 px-sm-1 mb-3" style="background-color:#275846;">{{ translate('I want to Hire') }}</a>
                                        <a href="{{route('register') }}?type=1" class="btn text-white fw-700 ml-4 fs-lg-18 fs-sm-12 py-lg-3 py-sm-1 px-lg-5 px-sm-1 mb-3" style="background-color:#275846;">{{ translate('I want to Work') }}</a>
                                    </div>
                                </div>
                ...
                <div class="col-lg-10">
                    <div class="aiz-carousel gutters-10" data-autoplay='true' data-items="6" data-xl-items="6" data-lg-items="5" data-md-items="4" data-sm-items="3" data-xs-items="2" data-infinite='true'>
                        <div class="caorusel-box d-flex ">
                            ...
                            <div class="col-2">
                                <img class="img-fluid" src="{{ url('/public/assets/Top-universities/victoria.png') }}" alt="Image" style="width:100px;" />
                            </div>

                            <div class="col-2">
                                <img class="img-fluid" src="{{ url('/public/assets/Top-universities/sydney.png') }}" alt="Image" style="width:100px;" />
                            </div>
                            <div class="col-2">
                                <img class="img-fluid" src="{{ url('/public/assets/Top-universities/adilade.png') }}" alt="Image" style="width:150px;" />
                            </div>
                            <div class="col-2">
                                <img class="img-fluid" src="{{ url('/public/assets/Top-universities/national university.jpg') }}" alt="Image" style="width:130px;" />
                            </div>


                            <div class="col-2">
                                <img class="img-fluid" src="{{ url('/public/assets/Top-universities/monas.jpg') }}" alt="Image" style="width:160px;" />
                            </div>
                            <div class="col-2">
                                <img class="img-fluid" src="{{ url('/public/assets/Top-universities/western sydney.jpg') }}" alt="Image" style="width:130px;" />
                            </div>
                        </div>
                ...
                <div class="">
                    ...
                    <div class="row">
                        <div class="col-xl-3 col-md-6">
                            <div class=" ">
                                <div class="d-flex ">
                                    <img class=" " src=" {{url('/public/assets/home/businessman.png')}}" alt="Image" style="width:33px;" />
        ...
        <section class="bg-white border-top">
            <div class=" container-home">
                <div class="d-flex justify-content-between ">
                    ...
                    <div>
                        <a href="{{ route('search') }}?category=" class="btn bg-white text-black fs-17 d-lg-none  rounded-1">{{ translate('Browse More Categories') }}
        ...
        <section class="border-top" style="background-color:#FBF7ED;">
            <div class="container-home" style=" ">
                        ...
                        <div class="caorusel-box">
                            <div class="card  rounded-1" style="height:400px">
                                <div class="">
                                    ...
                                    <div class="p-2">
                                        <div>
                                        @if ($service->project_cat_id != null)
                                            <p class="mt-3 mb-0 text-primary fs-14 fw-700">project category</p>
                                        @endif
                                            <p class="card-title mt-1 fs-18 fw-700"> {{ \Illuminate\Support\Str::limit($service->title, 45, $end = '...') }}</p>
                                            <div class="mt-2">
                                                <span>
                ...
                <div class="pt-2 text-center">
                    <a  href="{{ route('search') }}?keyword=&type=service" class="category-list fs-18 fw-400 "><span>All services</span></a>
            ...
            <div class="container-main">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-12">
                        <div class=" gutters-15 w-100" data-items="4" data-xl-items="3" data-md-items="2" data-sm-items="1" data-arrows='true'>
                            <div class="caorusel-box">
                                <div class="card  rounded-1" style="height:410px;">
                                    <div class="">
                                        <div class=" ">
                          ...
                          @endif
                                                ...
                                                <h2 class="fs-18 mb-1 h-45px">
                                                    <a href="{{ route('blog.details', $blog->slug) }}" class="text-dark fs-16 " title="{{ $blog->title }}">
            ...
            <div class="container-home">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <h5 class="nav-link fs-22 active text-decoration-underline" id="home-tab" data-toggle="tab" data-target="#home" role="tab" aria-controls="home" aria-selected="true">Top skills</h5>
                    </li>
                    <li class="nav-item" role="presentation">
                        <h5 class="nav-link fs-22" id="profile-tab" data-toggle="tab" data-target="#profile" role="tab" aria-controls="profile" aria-selected="false">Trending skills</h5>
                    </li>
                    <li class="nav-item" role="presentation">
                        <h5 class="nav-link fs-22" id="contact-tab" data-toggle="tab" data-target="#contact" role="tab" aria-controls="contact" aria-selected="false">Top skills in Australia</h5>
                    </li>
                    <li class="nav-item" role="presentation">
                        <h5 class="nav-link fs-22" id="contact-tab" data-toggle="tab" data-target="#contact" role="tab" aria-controls="contact" aria-selected="false">Project catalog</h5>
                    </li>
                </ul>

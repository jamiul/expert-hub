                            ...
                            <div class="row">
                                <div class="col-lg-7 col-sm-12 home-cacap-head">
                                    <h2 class=" sm-mx-auto fw-700 fs-lg-40 fs-sm-36px" style="">
                                        Hire the best consultations for any job, online</h2>
                                    <p class="fs-lg-20 fs-sm-14 my-4 ">Millions of people use scholarships Australia to turn their ideas into
                                        reality.</p>
                ...
                <div class="mt-5">
                    <div class="row ">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12" style="margin-bottom:20px;">
                            <div class="card  rounded-1 h-100  services-card" >
                                <div class="">
                        ...
                        <div class="col-lg-3  mb-sm-4 col-md-6 col-sm-12" style="margin-bottom:20px;">
                            <div class="card h-100 rounded-1" style="">
                                <div class="">

      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
         <ul class="navbar-nav align-items-center">
            ...
            <li class="nav-item dropdown">
               <a class="nav-link edux-dropdown-toggle" href="#" id="projectDrop" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                  My Projects
               </a>
            ...
            <li class="nav-item dropdown">
               <a class="nav-link  edux-dropdown-toggle" href="#" id="billingDrop" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                  Billing & Payments
               </a>
               <ul class="dropdown-menu" aria-labelledby="billingDrop">
                  <li>
                     <a class="dropdown-item" href="{{ route('expert.payment.index') }}">Get Paid</a>
                  </li>
                  <!-- <li>
            ...
            <li class="nav-item dropdown">
               <a class="nav-link  edux-dropdown-toggle activ" href="#" id="serviceDrop" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                  Settings
               </a>
              ...
              <ul class="ps-0 list-unstyled links mb-0">
               ...
               <li>
                   <form method="POST" action="{{ route('auth.logout') }}">
                       @csrf
                       <button onclick="event.preventDefault(); this.closest('form').submit();" class="d-inline-flex align-items-center small fw-medium">
                           <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">

...
@section('content')
    @php
        $type = Request::get('type') && Request::get('type') == 2 ? 'client' : 'expert';
    @endphp
                ...
                <div class=" col-xl-5 col-md-7 mx-auto">
                    <div class="card rounded-2 border-gray-light">
                        <div class="card-body">
                            ...
                            <form class="" id="reg-form" method="POST" action="">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <small>{{ translate('Minimum 6 characters') }}</small>
                                </div>

                                <div class="form-group mb-4">
                                    <div class="aiz-radio-inline">
                                        <label class="aiz-radio border-1">
                                            <input type="radio" name="user_types[]" value="expert"
                                                @if ($type == 'expert') checked @endif>
                                            {{ translate('As an Expert') }}
                                            <span class="aiz-rounded-check"></span>
                                        </label>
                                        <label class="aiz-radio border-1 p-">
                                            <input type="radio" name="user_types[]" value="client"

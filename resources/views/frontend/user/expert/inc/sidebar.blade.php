            ...
            <ul class="aiz-side-nav-list" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
                    <a href="javascript:void(0);" class="aiz-side-nav-link d-flex align-items-center">
                        ...
                        <span class="aiz-side-nav-text ml-2">{{ translate('Training') }}</span>
                        <span class="aiz-side-nav-arrow"></span>
                    </a>
                    <ul class="aiz-side-nav-list level-2">
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('training-consultant.create') }}" class="aiz-side-nav-link {{ areActiveRoutes(['training', 'training.create'])}}">
                                <span class="aiz-side-nav-text">{{ translate('Add New Training') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('training-consultant.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['service', 'service.edit'])}}">
                                <span class="aiz-side-nav-text">{{ translate('All Training') }}</span>
                            </a>
                        </li>
                        {{-- <li class="aiz-side-nav-item">
                            <a href="{{ route('service.sold') }}" class="aiz-side-nav-link {{ areActiveRoutes(['service.sold'])}}">
                                <span class="aiz-side-nav-text">{{ translate('Sold Training') }}</span>
                            </a>
                        </li> --}}
                    </ul>
                </li>
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('expert.packages.history') }}" class="aiz-side-nav-link {{ areActiveRoutes(['expert.packages.history'])}}">

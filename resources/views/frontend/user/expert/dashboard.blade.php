    ...
    <div class="container">
        <div class="d-flex align-items-start">
            ...
            <div class="aiz-user-panel">
                ...
                @endif
                @if(Auth::user()->userPackage->package_invalid_at != null && Carbon\Carbon::now()->diffInDays(Carbon\Carbon::parse(Auth::user()->userPackage->package_invalid_at), false) < 8) <div class="alert alert-danger mb-3">
            ...
            <div class="row gutters-15">
                <div class="col-md-4">
                    <div class="bg-primary text-white mb-4 overflow-hidden rounded-2 d-flex flex-column justify-content-between">
                        ...
                        <div class="mb-4 px-4">
                            <a href="{{ route('logout') }}" class="btn btn-block btn-soft-primary-light rounded-1 py-3 fs-14 fw-700">{{ translate('Logout') }}</a>
                        </div>
                    </div>
                </div>

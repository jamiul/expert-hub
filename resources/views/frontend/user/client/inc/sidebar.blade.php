    ...
    <div class="aiz-user-sidenav rounded overflow-hidden">
        ...
        <div class="sidemnenu mb-3 px-3">
            <ul class="aiz-side-nav-list" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('bookmarked-experts.index') }}" class="aiz-side-nav-link d-flex align-items-center {{ areActiveRoutes(['bookmarked-experts.index'])}}">
                        ...
                        <span class="aiz-side-nav-text ml-2">{{ translate('Bookmarked Experts') }}</span>
                    </a>
                </li>
                @endif
                @php

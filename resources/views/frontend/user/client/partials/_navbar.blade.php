    ...
    <div class="top-search-area">
        <div class="search-area">
            <div class="input-group header-search-group">
                ...
                <button class="btn btn-outline-secondary dropdown-toggle border border-end-0 no-hover search-select"
                    type="button" data-bs-toggle="dropdown" aria-expanded="false">Experts <span
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end message-setting-area">
                    ...
                    <div class="all-message-profile">
                        <div class="single-message-area d-flex flex-column justify-content-between">
                            <div class="single-message-item d-flex flex-row justify-content-between">
                                <div
                                    class="profile-message-area d-flex flex-row align-items-center justify-content-center gap-2">
                                    <div class="message-profile position-relative">
                                        <a href="#"><img
                                                src="{{ asset('assets/frontend/img/message-profile.png') }}"
                        ...
                        <div class="single-message-area d-flex flex-column justify-content-between">
                            <div class="single-message-item d-flex flex-row justify-content-between">
                                <div
                                    ...
                                    <div class="message-profile position-relative">
                                        <a href="#"><img
                                                src="{{ asset('assets/frontend/img/message-profile2.png') }}"
                                                alt="message profile"> <span class="indicator position-absolute"></span>
                                        </a>
                                    </div>
                                    <div class="message-text d-flex flex-column">
                                ...
                                <div class="message-count d-flex flex-column">
                                    <p>5 mins ago</p>
                                    <p class="btn-details">Details</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="single-message-area d-flex flex-column justify-content-between">
                            <div class="single-message-item d-flex flex-row justify-content-between">
                                <div
                                    ...
                                    <div class="message-profile position-relative">
                                        <a href="#"><img
                                                src="{{ asset('assets/frontend/img/message-profile3.png') }}"
                                                alt="message profile"> <span class="indicator position-absolute"></span>
                                        </a>
                                    </div>
                                    <div class="message-text d-flex flex-column">
                    ...
                    <div class="tatal-message-count d-flex justify-content-center align-content-center gap-3">
                        <span> <img src="{{ asset('assets/frontend/img/total-messge.png') }}" alt="total-message">
                        </span>
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu top-profile-setting">
                    ...
                    <div class="profile-setting-photo d-flex flex-column justify-content-center align-items-center">
                        <a href="#" class="setting-img"> <img
                                src="{{ asset('assets/frontend/img/profile.png') }}" alt="profile"> </a>

...
<body>
    ...
    <div class="mx-2 rounded-2 my-3 position-relative" style="background: #F2F7F2;">
      <div class="row py-3">
        <div class="col-lg-6 py-2 px-5  wrap ">
          ...
          <p class="how-to-hire-banner-text">
            {{translate('Find experts and run projects your way at the world’s work marketplace.')}}</p>
          ...
          <div class="position-absolute how-to-hire-banner-rating-section ">
            <p class=' fs-20'>Looking to get hired? <u class="text-success"><a class="text-decoration-underline "
                  href="#">Sign up here</a></u></p>
          </div>
  ...
  <div class="row container-main mb-5">
    ...
    <div class="col-lg-5 col-sm-12">
      ...
      <p class="get-work-child-detailsmt-2">Talk us through your budget and goals and we’ll do the recruitment for you.
        You’ll get a shortlist of our very best talent, all perfectly suited to the task.</p>
  ...
  <div class="row container-main">
    <div class="col-lg-6 col-sm-12 my-auto">
      ...
      <p class="get-work-child-details">As the world’s work marketplace, there’s more than one way to use Scholarship
        australia—and at least one that works for you. From quick project turnarounds to major strategic
        transformations, businesses of all sizes and ambitions can develop the trusted relationships they need to thrive
        and grow.</p>
    </div>
    <div class="col-lg-6 col-sm-12 ">

      <iframe width="515" height="315" src="https://www.youtube.com/embed/pQOnlFtLo3w" title="YouTube video player"
        frameborder="0"
      ...
      <div class="col-lg-5 col-sm-12  ml-lg-5 mx-sm-auto">
        <div>
          ...
          <p class="text-black fw-bold mb-4 fs-18">On hourly contracts, <span class="text-muted">we count keystrokes and
              take random screenshots of your expert’s screen so you can see they’re putting in the time.</span></p>

                ...
                <div class="col-lg-5 col-sm-12 mt-5 ml-5">
                    <div>
                        ...
                        <div class="mt-4">
                            ...
                            <p class="payment-work-child-details">{{translate('Invoice clients and track your earnings on EduExHub for a simple and streamlined process.')}}</p>
                        </div>
                        <div class="mt-4">
            ...
            <div class="mx-2 row">
                ...
                <div class="col-lg-6 col-sm-12 py-3">
                    ...
                    <div class=" border-bottom my-2">
                        ...
                        <h4 class="frequently-qsn-title">Is EduExHub free to join as a expert?</h4>
                        <p class="frequently-qsn-details">
                            Yes, it’s free to join EduExHub, complete your profile, search for work and create your own projects. Our service fee is based on your earnings with each client and the sliding scale rewards long-term relationships.
                        </p>
                    ...
                    <div class=" border-bottom">
                        ...
                        <h4 class="frequently-qsn-title">Can I grow my career on EduExHub?</h4>
                        <p class="frequently-qsn-details">
                            Yes, some of our most successful professionals have brought their strong background and employment track record to EduExHub. We know you may be new to freelancing but highly experienced in your field. Our
                        </p>
                        <div class="fre-content">
                            <p>
                    ...
                    <div class=" border-bottom ">
                        ...
                        <h4 class="frequently-qsn-details ">What can I gain from freelancing with EduExHub?</h4>
                        <p class="frequently-qsn-details">
                    ...
                    <div class=" border-bottom">
                        ...
                        <h4 class="frequently-qsn-title">Is EduExHub good for building a business? </h4>
                        <p class="frequently-qsn-details">
                            Yes, and creating an agency can be a great way to grow. Using our agency structure, experts can collaborate as a single organization, delivering more to their clients. Moving from solo expert to agency
                        </p>
                        <div class="fre-content">
                            <p>
                    ...
                    <div class=" border-bottom">
                        ...
                        <p class="frequently-qsn-details">
                            Connects are EduExHub’s virtual currency. Experts and agencies use them to show their genuine interest as they submit proposals. Different jobs require different amounts of Connects, some none at all.
                        </p>
                        <div class="fre-content">
                            <p>

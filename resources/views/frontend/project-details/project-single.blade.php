            ...
            @section('content')
                <div class="border-bottom">
                    <div class="container mt-4">
                        {{-- breadcrumb  --}}
                        @include('frontend.project-details.breadcrumb')
                    </div>
                </div>
                <section class="py-4 py-lg-5">
                    <div class="container">
                        <div class="mx-lg-5 mx-xl-5 mx-md-5 ">
                            <div class="row ">
                                <div class="col-xl-9 col-md-7 col-lg-8 pr-lg-0 border shadow-sm">
                                    @include('frontend.project-details.left-side')
                                </div>
                                <div class="col-xl-3 col-md-5  mt-lg-0 mt-sm-3 col-lg-5 pl-0 shadow-sm border">
                                    @include('frontend.project-details.right-side')
                                </div>
                            </div>
                        </div>
                        <div class="mx-4">
                            @include('frontend.project-details.projects')
                        </div>

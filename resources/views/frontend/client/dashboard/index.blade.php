                                    ...
                                    <div class="single-card-area">
                                        ...
                                        <div class="profile-single-button">
                                            <a href="{{ route('client.eois.index', $project) }}"
                                               class="btn btn-fundmilestone">Review Proposal</a>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
            ...
            <div class="row">
                <div class="all-job-area edux-all-job-area d-flex justify-content-between">
                    ...
                    <div class="view-all-expert">
                        <a href="{{ route('find.experts') }}" class="btn btn-primary edux-btn-primary">View All
                            Experts</a>
                    </div>
                </div>
            </div>
                                ...
                                <div class="developing-area">
                                    ...
                                    <div class="profile-single-button">
                                        <a href="{{ route('expert.profile.show', $expert) }}"
                                           class="btn btn-fundmilestone btn-viewprofile">View Profile</a>
                                    </div>
                                </div>
                            @endforeach
                        </div>

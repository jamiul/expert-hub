                                        ...
                                        <div class="draft-options">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-show">
                                                    <li>
                                                        <a class="dropdown-item " href="{{ route('client.eois.index', $project) }}">Invite Experts</a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('client.eois.index', $project) }}">View Job Posting</a>
                                                    </li>
                                                    <li>

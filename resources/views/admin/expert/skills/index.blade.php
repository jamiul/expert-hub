            ...
            <div class="card-body">
                <form class="form-horizontal" action="{{ route('skills.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-3 mt-4">
                        <select class="form-control aiz-selectpicker" name="parent_skill_id" id="parent_skill_id" data-live-search="true" title="{{ translate('Select category') }}"
                        >

            ...
            <div class="card-body">
                <form class="form-horizontal" action="{{ route('skills.update', $skill->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-3 mt-4">
                        <select class="form-control aiz-selectpicker" name="parent_skill_id" id="parent_skill_id" data-live-search="true" data-selected="{{ optional($skill->parent)->id }}" title="{{ translate('Select category') }}" required>
                            @foreach (\App\Models\Skill::whereNull('parent_id')->get() as $parentSkill)

                    ...
                    <div class="dashboard-inprogress">
                        <div class="admin-tab-nav-area d-flex flex-row justify-content-between">
                            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                <li class="nav-item " role="presentation">
                                    <button class=" admin-nav-link nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">In progress ({{ $activeContracts->count() }})</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link admin-nav-link" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false">Dispute ({{ $disputedContracts->count() }})</button>
                                </li>
                                <li class="nav-item" role="presentation">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <p class="mb-2">{{ $contract->project->title }}</p>
                                                <p>
                                                    <span class="text-black-50">From:</span> {{ $contract->created_at->format('M Y') }} to Present
                                                </p>
                                            </td>
                                            <td>
                                                <p class="mb-0 fw-medium">{{ $contract->project->type }}: ${{ $contract->amount }}</p>
                                                <p class="mb-0">Escrow: ${{ $contract->escrow_amount }}</p>
                                            </td>
                                            <td>
                                                <div class="user-card-small mb-3">
                                                    <div class="user-card-img">
                                                        <img class="rounded-circle" style="width:40px" src="{{ $contract->client->picture }}" alt="">
                                                    </div>
                                                    <div class="user-card-info">
                                                        <p class="mb-0 fw-bold">Client: {{ $contract->client->user->full_name }} </p>
                                                        <p class="mb-0">{{ $contract->client->current_organization }}</p>
                                                    </div>
                                                </div>
                                                <div class="user-card-small">
                                                    <div class="user-card-img">
                                                        <img class="rounded-circle" style="width:40px" src="{{ $contract->expert->picture }}" alt="">
                                                    </div>
                                                    <div class="user-card-info">
                                                        <p class="mb-0 fw-bold">Expert: {{ $contract->expert->user->full_name }} </p>
                            ...
                            <div style="padding-bottom: 150px;" class="tab-pane fade table-responsive" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab" tabindex="0">
                                ...
                                <table class="table border-0 edux-data-table text-sm pb-5">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="edux-batch edux-batch-waiting">{{ $contract->currentDispute()->status }}</span>
                                        </td>
                                        <td>
                                            <p class="mb-0">{{ $contract->project->type }}: ${{ $contract->amount }}</p>
                                            <p data-bs-toggle="modal" data-bs-target="#disputeReason-{{ $contract->id }}" class="mb-0 dispute-reason">Reason for dispute</p>
                                            <div class="modal fade" id="disputeReason-{{ $contract->id }}" tabindex="-1" aria-labelledby="disputeReasonModalLabel" aria-hidden="true">
                                                <div class="modal-dialog  modal-dialog-centered">
                                                    <div class="modal-content dropdown-comments-dispute px-4">
                                                        ...
                                                        <div class="comment-text">
                                                            <p class="mb-2"><span class="fw-medium">Client</span> {{ $contract->currentDispute()->created_at->format('d M Y') }}</p>
                                                            <p class="mb-2"><span class="fw-medium">Reason: </span> {{ $contract->currentDispute()->reason }}</p>
                                                            <p class="mb-2">{{ $contract->currentDispute()->description }}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <td>
                                            ...
                                            <div class="user-card-small">
                                                <div class="user-card-img">
                                                    <img style="width:40px" src="{{ $contract->expert->picture }}" alt="">
                                                </div>
                                                <div class="user-card-info">
                                                    <p class="mb-0 fw-bold">Expert: {{ $contract->expert->user->full_name }}</p>
                                                    <p class="mb-0">{{ $contract->expert->expertField->name }}</p>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu admin-d-item">
                                                    ...
                                                    <li>
                                                        @livewire('admin.contract.dispute.approve', ['contract' => $contract])
                                                    </li>
                                                    <li>
                                                        @livewire('admin.contract.dispute.decline', ['contract' => $contract])
                                                    </li>
                                                </ul>
                                            </div>
                                        </td>

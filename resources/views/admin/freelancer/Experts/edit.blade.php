        ...
        <div class="col-lg-6 offset-lg-3">
            <div class="card">
                <div class="card-header">
                    <h1 class="mb-0 h6">{{ translate('Edit Expert') }}</h1>
                </div>
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('expertise.update', $expert->id) }}" method="POST"
                        ...
                        <div class="form-group mb-3 mt-4">
                            <select class="form-control aiz-selectpicker" name="parent_id" id="parent_id"
                                data-live-search="true" data-selected="{{ optional($expert->parent)->id }}"

            ...
            <tr>
              ...
              <td class="text-right">
                ...
                <a class="btn btn-soft-primary btn-icon btn-circle btn-sm"
                  href="{{ route('consultant-categories.edit', encrypt($project_category->id)) }}"
                ...
                <a href="#" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete"
                  data-href="{{route('consultant-categories.destroy', encrypt($project_category->id))}}"
      ...
      <div class="card-body">
        <form class="form-horizontal" action="{{ route('consultant-categories.store') }}" method="POST"
          ...
          <div class="form-group mb-3">
            ...
            <input type="text" id="name" name="name" placeholder="{{ translate('Category Name') }}" class="form-control"
              required>
          </div>
          <div class="form-group mb-3">

...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <div class="row align-items-center">
        <div class="col-md-6">
            <h1 class="h3">{{translate('All who can apply Scholarship')}}</h1>
        </div>
    </div>
</div>
<div class="row">
  ...
  <div class="col-lg-5">
    <div class="card">
        ...
        <div class="card-body">
            <form class="form-horizontal" method="POST" action="{{ route('scholarship-who-can-apply.store') }}">
              @csrf
                <div class="form-group mb-3">
                    <label for="who_can_apply_title">{{translate('Name')}}</label>
                    <input type="text" id="who_can_apply_title" name="who_can_apply_title" placeholder="{{ translate('Title') }}" class="form-control" required>
                </div>

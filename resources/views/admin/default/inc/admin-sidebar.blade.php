  ...
  <div class="aiz-sidebar left c-scrollbar">
    ...
    <div class="aiz-side-nav-wrap">
      <ul class="aiz-side-nav-list" data-toggle="aiz-side-menu">
        ...
        @if(auth()->user()->can('show all clients') || auth()->user()->can('show client packages') ||
        ...
        @endif
        @if (\App\Models\Addon::where('unique_identifier', 'support_tickets')->first() != null &&
        ...
        <li class="aiz-side-nav-item">
          ...
          <ul class="aiz-side-nav-list level-2">
            ...
            @endcan
            @if(auth()->user()->can('show support settings category') || auth()->user()->can('show default assigned
            agent'))
            <li class="aiz-side-nav-item">
              <a href="#" class="aiz-side-nav-link">
              ...
              <ul class="aiz-side-nav-list level-3">
                ...
                <li class="aiz-side-nav-item">
                  ...
                  <ul class="aiz-side-nav-list level-2">
                    ...
                    @endcan
                    @if(auth()->user()->can('show support settings category') || auth()->user()->can('show default
                    assigned agent'))
                    <li class="aiz-side-nav-item">
                      <a href="#" class="aiz-side-nav-link">
                        <span class="aiz-side-nav-text">{{translate('Support Settings')}}</span>
                ...
                @if(auth()->user()->can('show header') || auth()->user()->can('show footer') ||
                auth()->user()->can('show pages') || auth()->user()->can('show apperance'))
                <li class="aiz-side-nav-item">
                  <a href="#" class="aiz-side-nav-link">
                ...
                @if (\App\Models\Addon::where('unique_identifier', 'offline_payment')->first() != null &&

        ...
        <div class="aiz-sidebar left c-scrollbar">
            ...
            <div class="aiz-side-nav-wrap">
                <ul class="aiz-side-nav-list" data-toggle="aiz-side-menu">
                                ...
                                @can('show project cancel requests')
                                    <li class="aiz-side-nav-item">
                                        <a href="{{ route('cancel-project-request.index') }}" class="aiz-side-nav-link">
                                            <span
                                                class="aiz-side-nav-text">{{ translate('Project Cancel Request') }}</span>
                                        </a>
                                    </li>
                                @endcan
                            ...
                            <ul class="aiz-side-nav-list level-2">
                                ...
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('service_cancellation.requests') }}" class="aiz-side-nav-link">
                                        <span
                                            class="aiz-side-nav-text">{{ translate('Service Cancellation Requests') }}</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                    ...
                    @if (auth()->user()->can('show all clients') ||
                            auth()->user()->can('show client packages') ||
                            auth()->user()->can('show client badges'))
                        <li class="aiz-side-nav-item">
                            <a href="#" class="aiz-side-nav-link">
                        ...
                        @if (auth()->user()->can('show active tickets') ||
                            ...
                            <li class="aiz-side-nav-item">
                                ...
                                <ul class="aiz-side-nav-list level-2">
                                    ...
                                    @endcan
                                    @if (auth()->user()->can('show support settings category') ||
                                            auth()->user()->can('show default assigned
                                                                                                                                                    agent'))
                                        <li class="aiz-side-nav-item">
                                            <a href="#" class="aiz-side-nav-link">
                                                <span
                                                    class="aiz-side-nav-text">{{ translate('Support Settings') }}</span>
                                                <span class="aiz-side-nav-arrow"></span>
                                            </a>
                        ...
                        <li class="aiz-side-nav-item">
                            ...
                            <ul class="aiz-side-nav-list level-2">
                                ...
                                @can('show package payments')
                                    <li class="aiz-side-nav-item">
                                        <a href="{{ route('package_payment_history_for_admin') }}"
                                            class="aiz-side-nav-link">
                                ...
                                @can('show service payments')
                                    <li class="aiz-side-nav-item">
                                        <a href="{{ route('service_payment_history_for_admin') }}"
                                            class="aiz-side-nav-link">
                                ...
                                @can('show all newsletters')
                                    <li class="aiz-side-nav-item">
                                        <a href="{{ route('newsletters.index') }}"
                                            class="aiz-side-nav-link {{ areActiveRoutes(['newsletters.index']) }}">
                    ...
                    @if (auth()->user()->can('show header') ||
                            auth()->user()->can('show footer') ||
                            auth()->user()->can('show
                                                                                pages') ||
                            auth()->user()->can('show apperance'))
                        <li class="aiz-side-nav-item">
                            <a href="#" class="aiz-side-nav-link">
                    ...
                    @endif
                    @if (auth()->user()->can('show all staffs') ||
                            auth()->user()->can('show employee roles'))
                        <li class="aiz-side-nav-item">
                            <a href="#" class="aiz-side-nav-link">
                                ...
                                @can('show all staffs')
                                    <li class="aiz-side-nav-item">
                                        <a href="{{ route('staffs.index') }}"
                                            class="aiz-side-nav-link {{ areActiveRoutes(['staffs.create', 'staffs.edit']) }}">
                            ...
                            <li class="aiz-side-nav-item">
                                ...
                                <ul class="aiz-side-nav-list level-2">
                                    ...
                                    @can('show offline project payments')
                                        <li class="aiz-side-nav-item">
                                            <a href="{{ route('offline_project_payments_history') }}"
                                                class="aiz-side-nav-link">
                                                <span
                                                    class="aiz-side-nav-text">{{ translate('Offline Project Payments') }}</span>
                                            </a>
                                        </li>
                                    @endcan
                                    ...
                                    @can('show offline package payments')
                                        <li class="aiz-side-nav-item">
                                            <a href="{{ route('offline_package_payments_history') }}"
                                                class="aiz-side-nav-link">
                                                <span
                                                    class="aiz-side-nav-text">{{ translate('Offline Package Payments') }}</span>
                                            </a>
                                        </li>
                                    @endcan
                                    ...
                                    @can('show offline service payments')
                                        <li class="aiz-side-nav-item">
                                            <a href="{{ route('offline_service_payments_history') }}"
                                                class="aiz-side-nav-link">
                                                <span
                                                    class="aiz-side-nav-text">{{ translate('Offline Service Payments') }}</span>
                                            </a>
                                        </li>
                                    @endcan
                                </ul>

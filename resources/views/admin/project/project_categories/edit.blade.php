  ...
  <div class="col-lg-6 offset-lg-3">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <form class="form-horizontal" action="{{ route('project-categories.update', $projectCategory->id) }}"
          ...
          <div class="form-group mb-3">
            ...
            <input type="text" id="name" name="name" placeholder="{{ translate('Category Name') }}"
              value="{{ $projectCategory->name }}" class="form-control" required>
          </div>
          <div class="form-group mb-3">
            ...
            <select class="select2 form-control aiz-selectpicker" name="parent_id" data-toggle="select2"
              ...
              <option value="0" @if ($projectCategory->parent_id == "0") selected @endif>{{ translate('No Parent') }}
              </option>
              @foreach($projectCategories as $projectCat)
              <option value="{{$projectCat->id}}" @if ($projectCat->id == $projectCategory->parent_id) selected
          ...
          <div class="form-group mb-3">
            ...
            <input type="text" id="description" name="description" placeholder="{{ translate('description') }}"
              value="{{ $projectCategory->description}}" class="form-control" required>
          </div>
          <div class="form-group mb-3">
            ...
            <div class="input-group" data-toggle="aizuploader" data-type="image">
              ...
              <input type="hidden" name="photo" class="selected-files" value="{{ $projectCategory->photo }}">
            </div>

      ...
      <div class="modal-body pt-0">
        ...
        <h1 class="modal-title fs-5 m-expert-title" id="exampleModalLabel">Add Expert</h1>
          ...
          <div class="admin-text-search position-relative">
              <span class="img-admin-search position-absolute"><img src="{{ asset('assets/frontend/img/admin-search.png') }}"> </span>
                ...
                <div class="database-block database-blog">
                  <div class="database-contant">
                    <div class="database-img">
                      <img src="{{ asset('assets/frontend/img/admin/ex1.png') }}">
                    </div>
                          ...
                          <div class="carousel-indicators">
                            <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="2" aria-label="Slide 3">
                              <h4 class="light-weight active">
                                <p>
                                  <img src="{{ asset('assets/frontend/img/admin/activelight.png') }}" alt="">
                                </p>
                                <p> keynote speaker</p>
                              </h4>
                            </button>
            ...
            <div class="right-sidebar">
              <div class="right-database">
                <div class="database-block database-blog">
                  <div class="database-contant">
                    <div class="database-img">
                      <img src="{{ asset('assets/frontend/img/admin/ex3.png') }}">
                    </div>
                    <div class="database-text admin-text">
                      <h4>
                        <a href="#">Professor Michael Kassiou</a>
                        ...
                        <div id="carouselExampleIndicators" class="carousel slide">
                          <div class="carousel-indicators">
                            <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="2" aria-label="Slide 3">
                              <h4 class="light-weight active">
                                <p>
                                  <img src="{{ asset('assets/frontend/img/admin/zoom-icon.png') }}" alt="">
                                </p>
                                <p> keynote speaker</p>
                              </h4>
                            </button>
          ...
          <div class="add-expert-single-item position-relative">
            <div class="right-sidebar">
              <div class="right-database">
                <div class="database-block database-blog">
                  <div class="database-contant">
                    <div class="database-img">
                      <img src="{{ asset('assets/frontend/img/admin/ex2.png') }}">
                    </div>
                    <div class="database-text admin-text">
                      <h4>
                        <a href="#">Professor Michael Kassiou</a>
            ...
            <div class="post-job add-expert-post position-absolute">
              <button class="btn btn-postjob d-flex justify-content-center  align-items-center" data-bs-toggle="modal" data-bs-target="#blogEditModal">
                <span class="material-symbols-outlined">add</span>
                <span>Add expert </span>
              </button>
            </div>
  ...
  <div class="modal-dialog modal-dialog-centered add-step-modal">
    ...
    <div class="modal-content ">
      ...
      <h1 class="modal-title fs-5" id="exampleModalLabel">Add Step</h1>
        ...
        <form>
          ...
          <div class="upload-file">
            <label class="btn btn-default btn-file d-flex justify-content-between basic-file-upload">
            <span class="file-icon"> Icon </span> <span><input type="file" style="display: none;" required></span>
            <span class="blog-upload"> Upload</span>
          </label>
          </div>


          <div class="my-2">
            <input type="text" class="form-control academic-title" id="recipient-name" placeholder="title">
          </div>
          <div class="mb-3">
      ...
      <div class="modal-footer border-0 add-step-footer">
        <button type="button" class="btn btn-primary btn-search-academy">Add</button>
      </div>
    </div>
  </div>
</div>

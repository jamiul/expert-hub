            ...
            <div class="row g-0">
                <div class="col-lg-8 col-xxl-9">
                    ...
                    <ul class="nav nav-tabs px-4 pt-4" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation"> <button class="nav-link" id="bestMatch-tab" data-bs-toggle="tab" data-bs-target="#bestMatch" type="button" role="tab" aria-controls="bestMatch" aria-selected="false">Best Match</button> </li>
                        <li class="nav-item" role="presentation"> <button class="nav-link" id="savedJobs-tab" data-bs-toggle="tab" data-bs-target="#savedJobs" type="button" role="tab" aria-controls="savedJobs" aria-selected="false">Saved Jobs</button> </li>
                    </ul> <!-- Tab panes -->
                ...
                <div class="col-lg-4 col-xxl-3 aside__wrapp">
                    <div class="px-3 px-sm-4 pt-5 pb-4 border-bottom">
                        <figure class="thumbnail__box rounded-circle mx-auto position-relative mb-2"> <img src="{{ asset('/assets/frontend/default/img/expert_dashboard/profile-img.png') }}" width="95" height="95" alt="Profile Thumbnail" class="img-fluid rounded-circle object-cover"> <span class="status active position-absolute rounded-circle d-flex justify-content-center align-items-center"></span> </figure>
                        <p class="text-center text-dark fw-medium mb-0">Professor Michael Kassiou</p>
                        <p class="text-center text-muted fw-normal mb-0 small lh-base"> Curriculum Expert <span class="d-block fw-medium">Public Health</span> </p>
                        <div class="mt-3">
                            <div class="d-inline-flex"> <span class="text-dark small fw-medium">Complete your profile</span> <a href="#" class="px-2"> <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="px-3 px-sm-4 py-4 border-bottom">
                        ...
                        <div class="d-flex justify-content-between align-items-center"> <small class="text-muted fw-medium">Available Now</small>
                            <div class="toggle-button-cover">
                                <div class="button-cover">
                                    <div class="button position-relative overflow-hidden b2" id="button-13"> <input type="checkbox" class="checkbox">

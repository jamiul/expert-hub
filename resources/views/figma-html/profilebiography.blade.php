        ...
        <div class="container my-5">
            <div class="row g-5 cprofiled">
                ...
                <div class="col-lg-8 col-md-7">
                    ...
                    <p>Please provide a brief biography, limited to 300 words, which will be used in your public profile.
                        Ensure
                        that it conveys meaningful information you would like the client to know about you before engaging
                        in
                        your project</p>
                    <div class="">
                        ...
                        <div class="col-md-12 mt-5">
                            ...
                            <div class="col-md-12 mt-4">
                                <div class="textOnInput">
                                    ...
                                    <input class="form-control mt-3 py-2" placeholder="eg. http://profile.com"
                                        type="text">
                                </div>
                            </div>
                        </div>

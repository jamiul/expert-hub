                        ...
                        <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab" tabindex="0">
                            ...
                            <div class="edux-paypal-visa-billing">
                                @if($user->expert_kyc->requirements && $user->expert_kyc->requirements['past_due'])
                                    <div class="alert edux-alert alert-danger" role="alert">
                                        ...
                                        <button type="button" class="view-requirement close" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile">
                                            View Requirements
                                        </button>
                                    </div>
                                @endif
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="col-4 text-end get-paid-end">
                                        <button
                                            ...
                                            class="btn btn-primary fs-15 fw-medium large__btn" data-bs-toggle="modal" data-bs-target="#modalGetPaid">Get Paid Now</button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mt-4 p-3 p-sm-4 border rounded-4">
                                <p class="mb-2 lead fw-medium text-black d-flex align-items-center">
                                    ...
                                    <button onclick="Livewire.dispatch('modal.open', { component: 'expert.payment.withdraw.schedule' })"
                                            data-bs-toggle="modal" data-bs-target="#modaltransactionedit" class="get-paid-all  btn btn__fab p-0 d-inline-flex justify-content-center align-items-center ms-1">
                            ...
                            <div class="edux-paypal-visa-billing mt-4  border rounded-4 edux-paypal-visa-billing-padding">
                                ...
                                <div class="single-button">
                                    <button
                                        onclick="Livewire.dispatch('modal.open', { component: 'expert.payment.withdraw.add' })"
                                        type="button" class="btn edux-btn-border-primary" data-bs-toggle="modal" data-bs-target="#addWithdrawal"> <span class="arrow-left">
                                            ...
                                            <tr class="edux-pending-payment">
                                                ...
                                                <td style="vertical-align: middle;"  class="edux-tbl-action">
                                                    <a onclick="Livewire.dispatch('modal.open', { component: 'expert.payment.kyc' })"
                                                       class="btn btn-primary fs-15 fw-medium large__btn" data-bs-toggle="modal" data-bs-target="#addKYC">Update</a>
                                                </td>
                                            </tr>
{{--                                        @endif--}}
{{--                                        @if($user->expert_kyc->requirements['past_due'])--}}
                                            <tr class="edux-pending-payment">
                                                ...
                                                <td style="vertical-align: middle;"  class="edux-tbl-action">
                                                    <a onclick="Livewire.dispatch('modal.open', { component: 'expert.payment.withdraw.add' })"
                                                       class="btn btn-primary fs-15 fw-medium large__btn" data-bs-toggle="modal" data-bs-target="#addWithdrawal">Update</a>

                                    ...
                                    <div class="col-md-8 col-12 p-0">
                                        <div class="post-header-content">
                                            <div class="consult-heading">
                                                ...
                                                <p>Boost your academic success with us! Share your project details,
                                                    browse profiles, contact academic experts, and pay only when you are
                                                    satisfied</p>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="job-post-form">
                            <form wire:submit="save">
                                ...
                                <div class="step step-1 mb-4">
                                    <div class="main-form">
                                        <x-form.input type="text" label="What is your project title?"
                                                      wire:model.blur="title" placeholder="Academic content writer"/>
                                    </div>
                                </div>
                                <div class="step step-2 mb-4">
                                    <x-form.countable-textarea label="Project Description" wire:model.blur="description"
                                    ...
                                    @enderror
                                    <p class="mt-2 mb-0 edux-supported-file">Supported files type: <span>Image, pdf, doc, excel (Max 10 MB)</span>
                                    </p>
                                    @if($project)
                                            ...
                                            <div class="customer-upload">
                                                <div class="upload-file-user">
                                                    <div class="upload-file-user-img">
                                                        <img
                                                            src="{{ asset('assets/frontend/img/uploadfile-icon.png') }}"/>
                                                    </div>
                                                ...
                                                <div wire:click="deleteAttachment({{ $attachment->id }})"
                                ...
                                <div class="step step-3 mt-3">
                                    <div class="main-form">
                                        <div class="skills">
                                            ...
                                            <p>List up to 8 key skills that represent your project. Academic experts
                                                will use these skills to match with projects aligned to their interests
                                                and expertise.</p>
                                            <x-form.choice wire:model.live="selectedSkills"
                                                           placeholder="Type the skills & hit enter" id="skills"
                                                           multiple>
                                                @foreach ($availableSkills as $name => $id)
                                                    <option value="{{ $id }}">{{ $name }}</option>
                                                @endforeach
                                            </x-form.choice>
                                            <div class="text-sm">Suggestion skills: <span
                                                    class="text-sm fw-medium">{{ $suggestedSkills->implode(', ') }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <div class="contact-type-card">
                                                    ...
                                                    <label class="contact-type-card-inner" for="Hourly">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p class="text-sm mb-0">Select freelancers based on their
                                                                hourly rates and pay for the hours worked</p>
                                                        </div>
                                                    </label>
                                                </div>
                                                <div class="contact-type-card">
                                                    ...
                                                    <label class="contact-type-card-inner" for="Fixed">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p class="text-sm mb-0">Agree on a price upfront, then
                                                                release payment upon project completion</p>
                                                        </div>
                                                    </label>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-input-group">
                                                            <label class="form-input-label edux-tooltip-level">Start
                                                                Amount <span class="edux-tooltips"> <i><x-icon.info
                                                                            width="20" height="20" fill="#A1A0A5"/></i> <span
                                                                        class="edux-tooltips-details">  Minimum start amount is $50 </span> </span>
                                                            </label>
                                                            <input id="budget_start_amount" class="form-input-field"
                                                                   type="number" wire:model.blur="budget_start_amount"
                                                    ...
                                                    <div class="col-md-6">
                                                        <x-form.input type="number" min="0" label="End Amount"
                                                                      wire:model.blur="budget_end_amount"
                                                                      placeholder="Type Here"/>
                                                    </div>
                                                </div>
                                            @else
                                ...
                                <div class="d-flex gap-3 mt-3">
                                    <button type="button" style="width: 265px"
                                            class="btn btn-md btn-outline-primary border-2" wire:click="saveAsDraft">
                                        Save As Draft
                                    </button>
                                    <button type="submit" style="width: 265px" class="btn btn-md btn-primary">Post
                                        Project
                                    </button>
                                </div>
                            </form>

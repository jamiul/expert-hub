    ...
    <div x-data="{ milestoneType: 'multiple' }"
        ...
        <div class="contact-type-card-wrapper mb-3">
            <div class="contact-type-card">
                <input type="radio" name="milestoneType"
                        id="multiple" class="d-none"
                        value="multiple" wire:model.live="milestoneType" x-model="milestoneType">
                <label class="contact-type-card-inner" for="multiple">
                    <div>
            ...
            <div class="contact-type-card">
                <input type="radio" name="milestoneType" id="single"
                        class="d-none"
                        value="single" wire:model.live="milestoneType" x-model="milestoneType">
                <label class="contact-type-card-inner" for="single">
                    <div>
                        <span class="radio-field-icon"></span>
                    </div>
                    <div>
        ...
        <div x-show="milestoneType === 'multiple'">
            ...
            <div class="mb-2">
                <div class="proposed-milestone-field-group">
                    <div>
                        <x-form.input label="Milestone Description" wire:model="milestone_description.0" placeholder="Type"/>
                    </div>
                    <div>
                ...
                @foreach ($milestones as $key => $value)
                    <div wire:key="{{ $key }}" class="proposed-milestone-field-group">
                        <div>
                            <x-form.input label="Milestone Description" wire:model="milestone_description.{{ $value }}" placeholder="Type"/>
                        </div>
                        <div>
                ...
                @endforeach
                 <!--proposed-milestone-field-group-->
                {{-- <div class="proposed-milestone-field-group">
                    <div>
                    ...
                    <div>
                        <x-form.input type="text" label="Deposit Amount"
                                        wire:model.live="milestone_amount" placeholder="$0.00"
                                        value=""/>
                    </div>
                    <div>
                        <button>
            ...
            <div class="proposed-milestone-offer-summary mt-40">
                ...
                <div class="milestone-offer-summary-item">
                    <h4>Platform Fee</h4>
                    <p class="mb-0">${{ $serviceFee }}</p>
                    <p class="mb-0">Platform fee 10%</p>
                </div>
                <div class="milestone-offer-summary-item">
                    <h4>You will receive</h4>
                    <p class="mb-0">${{ $amountAfterServiceFee }}</p>

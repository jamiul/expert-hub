                        ...
                        <div class="progress-step-content-wrapper">
                            ...
                            @if($currentStep === 2)
                                <div class="progress-step-content">
                                    ...
                                    <div class="pt-4">
                                        ...
                                        <div class="text-sm">Suggestion skills: <span class="text-sm fw-medium">Curriculum Editor, E-Learning Developer, Curriculum Writer, Curriculum Design, Research and Analysis, skill development</span>
                                        </div>
                                    </div>
                                        ...
                                        <div class="service-fee-input-row">
                                            ...
                                            <div class="service-fee-input">
                                                <div class="d-flex gap-4 align-items-center">
                                                    ...
                                                    <div>
                                                        <x-form.input type="number" wire:model.blur="hourly_rate"
                                                                      placeholder="0.00"/>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            @if($currentStep === 3)
                                <div class="progress-step-content ">
                                    ...
                                    <p class="mb-4">Please provide a brief biography, limited to 2000 characters, which
                                        will be
                                        used in
                                        your public
                                        profile. Ensure that it conveys meaningful information you would like the client
                                        to know
                                        about you before engaging in your project
                                    </p>
                                    <x-form.countable-textarea rows="5" cols="10" max="2000" name="biography"
                                                               wire:model.blur="biography"
                                                               placeholder="e.g. Brief 2000 characters summary about your expertise."/>
                                    ...
                                    <div class="image-upload-preview">
                                        ...
                                        <div>
                                            <label for="picture"
                                                ...
                                                <svg class="me-2" xmlns="http://www.w3.org/2000/svg" width="25"
                                                     height="24"
                                                     viewBox="0 0 25 24"
                                                     fill="none">
                                                    <path

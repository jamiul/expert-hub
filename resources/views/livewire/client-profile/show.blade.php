            ...
            <div class="col">
                <div class="sidebar-layout left-sidebar-layout client-profile">
                    <div class="page-sidebar">
                        {{-- Profile summary --}}
                        <livewire:profile.summary :editable="false" />
                        {{-- Education --}}
                        <livewire:profile.edit.education :editable="false" />
                    </div>
                    <div class="page-content">
                        {{-- Biography --}}
                        <livewire:profile.biography :editable="false" />
                        {{-- Experience --}}
                        <div class="page-block mt-40">
                            <livewire:profile.edit.experience :editable="false" />
                        </div>
                        <div class="page-block mt-40">

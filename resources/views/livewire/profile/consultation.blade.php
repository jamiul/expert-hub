    ...
    <div class="consultant-prof1 card-body border-0 edux-border-bottom pt-3">
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="prof-img">
                    <img
                        src="{{ asset('/assets/frontend/default/img/expert_dashboard/book-exprt1.jpg') }}"></img>
                </div>
            </div>
            <div class="col-md-9">
                <div class="prof-text">
                    <div class="edux-prof-text">
                        ...
                        <button
                            wire:click="$dispatch('modal.open', { component: 'profile.biography.edit', arguments: { profile: 2 }})"
                            class="icon-btn icon-btn-md border ">
                            <x-icon.edit />
                        </button>
                    </div>

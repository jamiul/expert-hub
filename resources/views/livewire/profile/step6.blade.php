<div class="progress-step-content ">
    ...
    <x-form.countable-textarea rows="5" cols="10" max="2000" name="biography" wire:model.blur="biography" placeholder="e.g. Brief 2000 words summary about your expertise."/>

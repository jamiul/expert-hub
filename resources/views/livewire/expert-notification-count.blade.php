<div>
    <div class="dropdown">
        ...
        <div class="dropdown-menu message__dropdown bg-white border-0" aria-labelledby="notificationDrop" wire:ignore.self>
            <ul class="list-unstyled ps-0 mb-0 mess__list">
                @forelse($unread_notifications as $unread_notification)
                <li class="d-flex align-items-center" wire:click="markAsRead('{{ $unread_notification->id }}')">
                    <figure class="mb-0 thumb__box position-relative">
                        <img src="{{ $unread_notification->data['avatar']  }}" class="rounded-circle object-fit-cover" width="48" height="48" alt="avatar">
                        <span class="status rounded-circle position-absolute"></span>
                    </figure>
                    <div class="caption">
                        <div class="d-flex">
                            <div class="left__box">
                                <p class="mb-0 small fw-medium text-dark">{{ @$unread_notification->data['title'] }}</p>
            ...
            <div class="text-center border-top footer__link">
                <a href="{{ route('notifications') }}" class="d-inline-flex align-items-center small fw-medium text-decoration-none">
                    ...
                    <span class="ps-2">View All notifications</span>
                </a>
            </div>
        </div>
    </div>

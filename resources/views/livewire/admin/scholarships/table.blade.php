                                        ...
                                        <div class="draft-options">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu admin-d-item ">
                                                    <li>
                                                        <button type="button" wire:click="$dispatch('modal.open', {component: 'admin.scholarships.edit', arguments: {'scholarship': {{$scholarship->id}} }})">Edit</button>
                                                        {{-- <a class="dropdown-item  dropdown-heading active"
                                                            href="#">
                                                            <span wire:click="$dispatch('modal.open', {component: 'admin.scholarships.edit', arguments: {'scholarship': {{$scholarship->id}} }})" type="button">Edit</span>
                                                        </a> --}}
                                                    </li>
                                                    <li>

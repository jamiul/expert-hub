                    ...
                    <div class="page-sidebar">
                        <div class="sidebar-widget bb-1 mb-4">
                            <button class="btn btn-primary btn-md w-100"
                                onclick="Livewire.dispatch('modal.open', {component: 'training.register', arguments: {'training': {{ $training }} }})">
                                Register Now</button>
                            ...
                            <div class="mt-2 share-widget">
                                <button wire:click="favouriteTraining({{ $training->id }})"
                                    class="btn btn-icon btn-outline-light btn-favorite w-100 {{ $training->favourited() ? 'favorited' : '' }}">
                        ...
                        <div class="sidebar-widget">
                            <div class="training-summary-widget">
                                <div>
                                    ...
                                    <p class="m-0 text-sm fw-medium">{{ $training->start_date->format('d F Y') }} -
                                ...
                                <div>
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div>
                                            <p class="m-0 text-sm fw-medium text-primary">{{ $training->mode?->value }}
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div>
                                    ...
                                    <p class="m-0 text-sm fw-medium">{{ $training->start_time }} AEST,
                                        {{ $training->state?->name }}, {{ $training->country?->name }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="expert-card py-3">
                                            <div class="expert-card-header mb-2">
                                                ...
                                                <div class="expert-info">
                                                    <h3 class="h6 expert-name mb-0">
                                                        {{ $instructor->user->full_name ?? '' }}</h3>
                                                ...
                                                <div class="expert-card-action">
                                                    ...
                                                    <button class="btn btn-md btn-outline-primary border-2"> Invite
                                                        Project</button>
                                                </div>
                                            </div>

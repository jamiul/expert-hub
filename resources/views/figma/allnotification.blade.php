...
<div class="container">
        ...
        <div class="alert edux-alert-success  fade show d-flex justify-content-between" role="alert">
            <div class="alert-item">
              <span class="alert-icon">
                ...
                <path d="M10 0C4.48 0 0 4.48 0 10C0 15.52 4.48 20 10 20C15.52 20 20 15.52 20 10C20 4.48 15.52 0 10 0ZM8 15L3 10L4.41 8.59L8 12.17L15.59 4.58L17 6L8 15Z" fill="#5ABC76"/>
              </svg>
              </span>
              <span class="alert-text">Your EOI has been submitted successfully!</span>
            </div>
            <button type="button" class="edux-btn-close" data-bs-dismiss="alert" aria-label="Close"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
              <path d="M6.39953 18.6538L5.3457 17.6L10.9457 12L5.3457 6.40002L6.39953 5.34619L11.9995 10.9462L17.5995 5.34619L18.6534 6.40002L13.0534 12L18.6534 17.6L17.5995 18.6538L11.9995 13.0538L6.39953 18.6538Z" fill="black"/>
            </svg>
            </button>
        </div>
      </div>
      ...
      <div class="single-alert">
        <div class="alert edux-alert-error  fade show d-flex justify-content-between" role="alert">
            <div class="alert-item">
              <span class="alert-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                  <path d="M11 17H13V11H11V17ZM12 9C12.2833 9 12.5208 8.90417 12.7125 8.7125C12.9042 8.52083 13 8.28333 13 8C13 7.71667 12.9042 7.47917 12.7125 7.2875C12.5208 7.09583 12.2833 7 12 7C11.7167 7 11.4792 7.09583 11.2875 7.2875C11.0958 7.47917 11 7.71667 11 8C11 8.28333 11.0958 8.52083 11.2875 8.7125C11.4792 8.90417 11.7167 9 12 9ZM12 22C10.6167 22 9.31667 21.7375 8.1 21.2125C6.88333 20.6875 5.825 19.975 4.925 19.075C4.025 18.175 3.3125 17.1167 2.7875 15.9C2.2625 14.6833 2 13.3833 2 12C2 10.6167 2.2625 9.31667 2.7875 8.1C3.3125 6.88333 4.025 5.825 4.925 4.925C5.825 4.025 6.88333 3.3125 8.1 2.7875C9.31667 2.2625 10.6167 2 12 2C13.3833 2 14.6833 2.2625 15.9 2.7875C17.1167 3.3125 18.175 4.025 19.075 4.925C19.975 5.825 20.6875 6.88333 21.2125 8.1C21.7375 9.31667 22 10.6167 22 12C22 13.3833 21.7375 14.6833 21.2125 15.9C20.6875 17.1167 19.975 18.175 19.075 19.075C18.175 19.975 17.1167 20.6875 15.9 21.2125C14.6833 21.7375 13.3833 22 12 22Z" fill="#FF0000"/>
                </svg>
              </span>
  ...
  <div class="row">
      ...
      <div class="col-md-3">
            <div class="single-button">
              <button  type="button" class="btn edux-btn-border-primary"> <span class="arrow-left"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
        ...
        <ul>
          <li>
            <a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                <path d="M8.00023 11.5133L10.7669 13.1867C11.2736 13.4933 11.8936 13.04 11.7602 12.4667L11.0269 9.31999L13.4736 7.19999C13.9202 6.81332 13.6802 6.07999 13.0936 6.03332L9.87356 5.75999L8.61356 2.78665C8.3869 2.24665 7.61356 2.24665 7.3869 2.78665L6.1269 5.75332L2.9069 6.02665C2.32023 6.07332 2.08023 6.80665 2.5269 7.19332L4.97356 9.31332L4.24023 12.46C4.1069 13.0333 4.7269 13.4867 5.23356 13.18L8.00023 11.5133Z" fill="#E9B911"/>
              </svg>
            </a>
          </li>
          <li>

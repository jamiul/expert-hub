                ...
                <div class="col-md-10">
                    <div class="title-page-wrapper">
                        ...
                        <div class="title-page-body p-40">
                            ...
                            <div class="card mb-40">
                                <div class="card-body">
                                    ...
                                    <div style="max-width: 256px">
                                        <x-form.select class="form-input-group input-field-md" label="Project Duration" wire:model="title">
                            ...
                            <button class="btn btn-outline-primary me-3 btn-md mt-20 project-eoi-submit-btn"> Cancel</button>

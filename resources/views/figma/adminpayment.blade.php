                  ...
                  <div class="admin-tab-nav-area d-flex flex-row justify-content-between">
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                      <li class="nav-item " role="presentation">
                        <button class=" admin-nav-link nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">In Escrow(3)</button>
                      </li>
                      <li class="nav-item" role="presentation">
                        <button class="nav-link admin-nav-link" id="pills-complete-tab2" data-bs-toggle="pill" data-bs-target="#pills-contact-complete2" type="button" role="tab" aria-controls="pills-contact-completed" aria-selected="false">In Transit (23)</button>
                      </li>
                      <li class="nav-item" role="presentation">
                        <button class="nav-link admin-nav-link" id="pills-complete-tab" data-bs-toggle="pill" data-bs-target="#pills-contact-complete" type="button" role="tab" aria-controls="pills-contact-completed" aria-selected="false">Completed (3)</button>
                      </li>

                      <li class="nav-item" role="presentation">
                        <button class="nav-link admin-nav-link" id="pills-complete-tab" data-bs-toggle="pill" data-bs-target="#pills-contact-dispute" type="button" role="tab" aria-controls="pills-contact-completed" aria-selected="false">Dispute (23)</button>
                      </li>

                      <li class="nav-item" role="presentation">
                        <button class="nav-link admin-nav-link" id="pills-complete-tab" data-bs-toggle="pill" data-bs-target="#pills-contact-refund" type="button" role="tab" aria-controls="pills-contact-completed" aria-selected="false">Refund (23)</button>
                      </li>

                      <li class="nav-item" role="presentation">
                        <button class="nav-link admin-nav-link" id="pills-complete-tab" data-bs-toggle="pill" data-bs-target="#pills-contact-reverse" type="button" role="tab" aria-controls="pills-contact-completed" aria-selected="false">Reverse (23)</button>
                      </li>

                      <li class="nav-item" role="presentation">
                        <button class="nav-link admin-nav-link" id="pills-complete-tab" data-bs-toggle="pill" data-bs-target="#pills-contact-payout" type="button" role="tab" aria-controls="pills-contact-payout" aria-selected="false">Payout (23)</button>
                      </li>

                      <li class="nav-item" role="presentation">
                        <button class="nav-link admin-nav-link" id="pills-complete-tab" data-bs-toggle="pill" data-bs-target="#pills-all-transaction" type="button" role="tab" aria-controls="pills-contact-completed" aria-selected="false">All Transactions (23)</button>
                      </li>
...
<div class="tab-pane fade" id="pills-contact-dispute" role="tabpanel" aria-labelledby="pills-contact-tab" tabindex="0">
                    ...
                    <table class="table table-hover transaction-all-payment">
                      ...
                      <tbody class="">
                        <tr>
                          ...
                          <td class="balance-text">13617</td>
                          <td>345785</td>
                          <td><span class="discord-reason">#232323</span></td>
                          <td>
                            <span class="spent-price">$500</span>
                          </td>
                          <td>
...
<div class="tab-pane fade" id="pills-contact-refund" role="tabpanel" aria-labelledby="pills-contact-tab" tabindex="0">
                    ...
                    <table class="table table-hover transaction-all-payment">
                      ...
                      <tbody class="">
                        <tr>
                          ...
                          <td class="balance-text">13617</td>
                          <td>345785</td>
                          <td><span class="discord-reason">Project not delivered</span></td>
                          <td>
                            <span class="spent-price">$500</span>
                          </td>
                          ...
                          <td><span class="fixed-screw">Full Refund</span></td>
                            ...
                            <div class="policy-option">
                              <div class="draft-options">
                                <div class="dropdown">
                                  ...
                                  <ul class="dropdown-menu admin-d-item">
                                    <li>
                                      <button class="dropdown-item">Refund Reverse</a>
                                    </li>
                                  </ul>
                                </div>
                              </div>
                        ...
                        <tr>
                          ...
                          <td class="balance-text">13617</td>
                          <td>345785</td>
                          <td><span class="discord-reason">Failed to meet Deadline</span></td>
                          <td>
                            <span  class="spent-price">$500</span>
                          </td>
                          <td>$500</td>
                        ...
                        <tr>
                          ...
                          <td class="balance-text">13617</td>
                          <td>345785</td>
                          <td><span class="discord-reason">Misrepresentation of skills or experience</span></td>
                          <td>
                            <span  class="spent-price">$500</span>
                          </td>
                          <td>$500</td>
                        ...
                        <tr>
                          ...
                          <td class="balance-text">13617</td>
                          <td>345785</td>
                          <td><span class="discord-reason">Violation of Upwork's Terms of Service</span></td>
                          <td>
                            <span  class="spent-price">$500</span>
                          </td>
                          <td>$500</td>
                        ...
                        <tr>
                          ...
                          <td class="balance-text">13617</td>
                          <td>345785</td>
                          <td><span class="discord-reason">Technical issues</span></td>
                          <td>
                            <span class="spent-price">$500</span>
                          </td>
                          <td>$500</td>
                        ...
                        <tr>
                          ...
                          <td class="balance-text">13617</td>
                          <td>345785</td>
                          <td><span class="discord-reason">Non-payment by client</span></td>
                          <td>
                            <span class="spent-price">$500</span>
                          </td>
                          <td>$500</td>
                        ...
                        <tr>
                          ...
                          <td class="balance-text">13617</td>
                          <td>345785</td>
                          <td><span class="discord-reason">Project scope changes</span></td>
                          <td>
                            <span class="spent-price">$500</span>
                          </td>
                          <td>$500</td>
                        ...
                        <tr>
                          ...
                          <td class="balance-text">13617</td>
                          <td>345785</td>
                          <td><span class="discord-reason">Client's fault for project failure</span></td>
                          <td>
                            <span class="spent-price">$500</span>
                          </td>
                          <td>$500</td>
...
<div class="tab-pane fade" id="pills-contact-reverse" role="tabpanel" aria-labelledby="pills-contact-tab" tabindex="0">
...
<div class="tab-pane fade" id="pills-contact-payout" role="tabpanel" aria-labelledby="pills-contact-tab" tabindex="0">
                       <div class="container-fluid">
                        <div class="row">
                          <div class="col-md-12">
                            <section class="admin-dashboard-area-client  mx-auto ">
                                      ...
                                      <div class="balance-table-area-admin d-flex flex-column table-responsive">
                                        <table class="table table-hover transaction-all-payment">
                                          <thead class="t-history">
                                            <tr>
                                            <th>
                                              <p  class="payment-date"><input class="form-check-input mt-0 admin-all-checkbox" type="checkbox" value="" aria-label="Checkbox for following text input"> <span class="date-range">Transection <br/> Date</span> <span class="material-symbols-outlined th-arrow">unfold_more </span> </p>
                                              </th>
                                          ...
                                          <tbody class="">
                                            ...
                                            <tr>
                                              ...
                                              <td>$25</td>
                                              <td>$3</td>
                                              <td> <span class="fixed-screw">Hourly</span></td>
                    ...
                    <div class="tab-pane fade" id="pills-all-transaction" role="tabpanel" aria-labelledby="pills-contact-tab" tabindex="0">
                       <div class="container-fluid">
                        <div class="row">
                          <div class="col-md-12">
                            <section class="admin-dashboard-area-client  mx-auto ">

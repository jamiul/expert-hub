            ...
            <div class="container">
                <form id="form" action="/">
                    ...
                    <div class="without-draw-button">
                        <button type="submit" class="btn-with-draw-paypal d-flex justify-content-center align-items-center  gap-2" ><a class="nav-link " href="/figma/client-addpaymentdouable" >Add My  Card</a>  </button>
                      </div>
                </form>
            </div>
          </div>

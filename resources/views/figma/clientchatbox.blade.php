...
<div class="container-fluid p-0">
  <div class="edux-chatbox-area">
      ...
      <div class="edux-main-area">
          <div class="edux-middle-area edux-middle-area-desktop">
                ...
                <div class="middle-top-area">
                  ...
                  <div class="middle-top-right">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                      ...
                      <a href="#" onclick="FncRightSidebar()">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                        <path d="M9 15H11V9H9V15ZM10 7C10.2833 7 10.5208 6.90417 10.7125 6.7125C10.9042 6.52083 11 6.28333 11 6C11 5.71667 10.9042 5.47917 10.7125 5.2875C10.5208 5.09583 10.2833 5 10 5C9.71667 5 9.47917 5.09583 9.2875 5.2875C9.09583 5.47917 9 5.71667 9 6C9 6.28333 9.09583 6.52083 9.2875 6.7125C9.47917 6.90417 9.71667 7 10 7ZM10 20C8.61667 20 7.31667 19.7375 6.1 19.2125C4.88333 18.6875 3.825 17.975 2.925 17.075C2.025 16.175 1.3125 15.1167 0.7875 13.9C0.2625 12.6833 0 11.3833 0 10C0 8.61667 0.2625 7.31667 0.7875 6.1C1.3125 4.88333 2.025 3.825 2.925 2.925C3.825 2.025 4.88333 1.3125 6.1 0.7875C7.31667 0.2625 8.61667 0 10 0C11.3833 0 12.6833 0.2625 13.9 0.7875C15.1167 1.3125 16.175 2.025 17.075 2.925C17.975 3.825 18.6875 4.88333 19.2125 6.1C19.7375 7.31667 20 8.61667 20 10C20 11.3833 19.7375 12.6833 19.2125 13.9C18.6875 15.1167 17.975 16.175 17.075 17.075C16.175 17.975 15.1167 18.6875 13.9 19.2125C12.6833 19.7375 11.3833 20 10 20Z" fill="#0036E3"/>
                        </svg>
                      </a>
                  </div>
                </div>
...
<div class="edux-expand-mini" id="leftSidebar2">

<div class="edux-message-right edux-message-right-mobile hide" id="eduxMessage">
<div class="edux-middle-area edux-middle-area-mobile">
<div class="row m-0 p-0">
    <div class="middle-top-area">
      <div class="middle-top-left">
        <div class="middle-top-img">
        <button onclick="show()"><img class="middle-top-arrow" src="{{ asset('assets/frontend/img/arrow-left.png') }}" alt="avatar"></button>
        <img class="middle-top-avatar" src="{{ asset('assets/frontend/img/avatar-middle.png') }}" alt="avatar">
        </div>
        <div class="middle-top-text">
            <h5>Miles, Esther</h5>
            <p>Curriculum Expert </p>
...
<button class="edux-button-click edux-button-click-message" onclick="myMessageFunction()">
    ...
    <div class="ctx-text-area">
      ...
      <div class="ctx-with-draft">
          <div class="ctx-body">
            ...
            <div class="draft-options edux-draft-options-all d-none">
            <div class="dropdown">
  ...
  <div class="body-content edux-margin-left">
    ...
    <div class="ctx-title">
      ...
      <div class="edux-with-option">
          <div class="ctx-body">
            <p>Vatoque penatibus et magnis dis parturient montes</p>
            <div class="ctx-title justify-content-end me-3 mb-2 d-none">
                <span class ="ctx-time">10:05 PM</span>
                <span class="ctx-person"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                  <path d="M6.20834 14.8958L1.60417 10.2917L2.45834 9.42709L6.20834 13.1771L7.07292 14.0313L6.20834 14.8958ZM9.60417 14.8958L5.00001 10.2917L5.86459 9.43751L9.60417 13.1771L17.5521 5.22917L18.4167 6.08334L9.60417 14.8958ZM9.60417 11.5L8.75001 10.6458L14.1667 5.22917L15.0104 6.09376L9.60417 11.5Z" fill="#369450"/>
                </svg>
              </span>
            </div>
          </div>
  ...
  <div class="edux-all-message-body"> <span>12 Oct 2023</span> </div>
  ...
  <div class="body-content edux-margin-left">
    ...
    <div class="edux-with-option d-none">
          <div class="ctx-body">
            ...
            <div class="ctx-title justify-content-end me-3 mb-2">
                <span class ="ctx-time">10:05 PM</span>
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                  <path d="M6.20834 14.8958L1.60417 10.2917L2.45834 9.42709L6.20834 13.1771L7.07292 14.0313L6.20834 14.8958ZM9.60417 14.8958L5.00001 10.2917L5.86459 9.43751L9.60417 13.1771L17.5521 5.22917L18.4167 6.08334L9.60417 14.8958ZM9.60417 11.5L8.75001 10.6458L14.1667 5.22917L15.0104 6.09376L9.60417 11.5Z" fill="#A1A0A5"/>
                </svg>
              </span>
            </div>
          </div>
  ...
  <div class="edux-type-message position-relative mb-4">
    ...
    <div class="edux-text-body-expand">
      <button class="border-0 bg-white edux-button-click" onclick="hide2()">
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                  ...
                  <ul>
                    ...
                    <li>
                      <a href="#" class="dropdown-toggle" id="moreOptions" data-bs-toggle="dropdown" aria-expanded="false">
                        <span>
                          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                      <path d="M7.99996 13.3333C7.63329 13.3333 7.3194 13.2028 7.05829 12.9417C6.79718 12.6805 6.66663 12.3667 6.66663 12C6.66663 11.6333 6.79718 11.3194 7.05829 11.0583C7.3194 10.7972 7.63329 10.6667 7.99996 10.6667C8.36663 10.6667 8.68051 10.7972 8.94163 11.0583C9.20274 11.3194 9.33329 11.6333 9.33329 12C9.33329 12.3667 9.20274 12.6805 8.94163 12.9417C8.68051 13.2028 8.36663 13.3333 7.99996 13.3333ZM7.99996 9.33332C7.63329 9.33332 7.3194 9.20277 7.05829 8.94166C6.79718 8.68054 6.66663 8.36666 6.66663 7.99999C6.66663 7.63332 6.79718 7.31943 7.05829 7.05832C7.3194 6.79721 7.63329 6.66666 7.99996 6.66666C8.36663 6.66666 8.68051 6.79721 8.94163 7.05832C9.20274 7.31943 9.33329 7.63332 9.33329 7.99999C9.33329 8.36666 9.20274 8.68054 8.94163 8.94166C8.68051 9.20277 8.36663 9.33332 7.99996 9.33332ZM7.99996 5.33332C7.63329 5.33332 7.3194 5.20277 7.05829 4.94166C6.79718 4.68055 6.66663 4.36666 6.66663 3.99999C6.66663 3.63332 6.79718 3.31943 7.05829 3.05832C7.3194 2.79721 7.63329 2.66666 7.99996 2.66666C8.36663 2.66666 8.68051 2.79721 8.94163 3.05832C9.20274 3.31943 9.33329 3.63332 9.33329 3.99999C9.33329 4.36666 9.20274 4.68055 8.94163 4.94166C8.68051 5.20277 8.36663 5.33332 7.99996 5.33332Z" fill="#0036E3"/>
                    </svg>
                  </span>
                  <span>More</span>
                </a>
  ...
  <!-- ============================================= Large area Editor start =================================== -->
  <div class="edux-chatbox-body-ara">
<div class="edux-expand-large hide" id="eduxMessage2">
...
<div class="row m-0 p-0">
    <div class="middle-top-area">
      <div class="middle-top-left">
        <div class="middle-top-img">
        <button onclick="show2()"><img class="middle-top-arrow" src="{{ asset('assets/frontend/img/arrow-left.png') }}" alt="avatar"></button>
        <img class="middle-top-avatar" src="{{ asset('assets/frontend/img/avatar-middle.png') }}" alt="avatar">
        </div>
        <div class="middle-top-text">
            <h5>Miles, Esther</h5>
  ...
  <div class="edux-type-message position-relative edux-type-message-large mb-4">
    <textarea name="" id="" cols="30" rows="10" placeholder="Type your message..."></textarea>
    <div class="text-body-img">
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
        <path d="M15.5 11C15.9167 11 16.2708 10.8542 16.5625 10.5625C16.8542 10.2708 17 9.91667 17 9.5C17 9.08333 16.8542 8.72917 16.5625 8.4375C16.2708 8.14583 15.9167 8 15.5 8C15.0833 8 14.7292 8.14583 14.4375 8.4375C14.1458 8.72917 14 9.08333 14 9.5C14 9.91667 14.1458 10.2708 14.4375 10.5625C14.7292 10.8542 15.0833 11 15.5 11ZM8.5 11C8.91667 11 9.27083 10.8542 9.5625 10.5625C9.85417 10.2708 10 9.91667 10 9.5C10 9.08333 9.85417 8.72917 9.5625 8.4375C9.27083 8.14583 8.91667 8 8.5 8C8.08333 8 7.72917 8.14583 7.4375 8.4375C7.14583 8.72917 7 9.08333 7 9.5C7 9.91667 7.14583 10.2708 7.4375 10.5625C7.72917 10.8542 8.08333 11 8.5 11ZM12 17.5C13.1333 17.5 14.1625 17.1792 15.0875 16.5375C16.0125 15.8958 16.6833 15.05 17.1 14H15.45C15.0833 14.6167 14.5958 15.1042 13.9875 15.4625C13.3792 15.8208 12.7167 16 12 16C11.2833 16 10.6208 15.8208 10.0125 15.4625C9.40417 15.1042 8.91667 14.6167 8.55 14H6.9C7.31667 15.05 7.9875 15.8958 8.9125 16.5375C9.8375 17.1792 10.8667 17.5 12 17.5ZM12 22C10.6167 22 9.31667 21.7375 8.1 21.2125C6.88333 20.6875 5.825 19.975 4.925 19.075C4.025 18.175 3.3125 17.1167 2.7875 15.9C2.2625 14.6833 2 13.3833 2 12C2 10.6167 2.2625 9.31667 2.7875 8.1C3.3125 6.88333 4.025 5.825 4.925 4.925C5.825 4.025 6.88333 3.3125 8.1 2.7875C9.31667 2.2625 10.6167 2 12 2C13.3833 2 14.6833 2.2625 15.9 2.7875C17.1167 3.3125 18.175 4.025 19.075 4.925C19.975 5.825 20.6875 6.88333 21.2125 8.1C21.7375 9.31667 22 10.6167 22 12C22 13.3833 21.7375 14.6833 21.2125 15.9C20.6875 17.1167 19.975 18.175 19.075 19.075C18.175 19.975 17.1167 20.6875 15.9 21.2125C14.6833 21.7375 13.3833 22 12 22ZM12 20C14.2333 20 16.125 19.225 17.675 17.675C19.225 16.125 20 14.2333 20 12C20 9.76667 19.225 7.875 17.675 6.325C16.125 4.775 14.2333 4 12 4C9.76667 4 7.875 4.775 6.325 6.325C4.775 7.875 4 9.76667 4 12C4 14.2333 4.775 16.125 6.325 17.675C7.875 19.225 9.76667 20 12 20Z" fill="#191D24"/>
    ...
    <div class="edux-text-body-expand">
    <button class="border-0 bg-white edux-button-click" onclick="show2()">
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
          <path d="M3.33333 18.3333V16.6667H16.6667V18.3333H3.33333ZM9.99999 15.8333L6.66666 12.5L7.83333 11.3333L9.16666 12.625V7.37499L7.83333 8.66666L6.66666 7.49999L9.99999 4.16666L13.3333 7.49999L12.1667 8.66666L10.8333 7.37499V12.625L12.1667 11.3333L13.3333 12.5L9.99999 15.8333ZM3.33333 3.33332V1.66666H16.6667V3.33332H3.33333Z" fill="#191D24" fill-opacity="0.7"/>
        </svg>
    </button>
    ...
    <div class="text-area-icon edux-text-area-icon">
        <div class="text-area-icon-left">
        <ul>
          <li><a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path d="M7.33984 18.625V5.375H12.2013C13.2206 5.375 14.142 5.69231 14.9657 6.32693C15.7895 6.96154 16.2013 7.81603 16.2013 8.89038C16.2013 9.63779 16.0209 10.2471 15.66 10.7183C15.2991 11.1894 14.9103 11.5314 14.4936 11.7442C15.0064 11.9211 15.4962 12.2708 15.9628 12.7933C16.4295 13.3157 16.6628 14.0192 16.6628 14.9038C16.6628 16.182 16.1917 17.1217 15.2494 17.723C14.3071 18.3243 13.3577 18.625 12.4013 18.625H7.33984ZM9.48977 16.6327H12.3206C13.1078 16.6327 13.6642 16.4141 13.9898 15.9769C14.3155 15.5397 14.4783 15.1205 14.4783 14.7192C14.4783 14.3179 14.3155 13.8987 13.9898 13.4615C13.6642 13.0243 13.0924 12.8057 12.2744 12.8057H9.48977V16.6327ZM9.48977 10.875H12.084C12.6917 10.875 13.1735 10.7013 13.5292 10.3539C13.885 10.0064 14.0629 9.59037 14.0629 9.10575C14.0629 8.59035 13.8748 8.16918 13.4985 7.84225C13.1222 7.51533 12.661 7.35188 12.1148 7.35188H9.48977V10.875Z" fill="#303744" fill-opacity="0.7"/>
...
<div class="edux-message-right edux-message-right-desktop">
            <div class="edux-middle-area edux-middle-area-mobile">
            <div class="row m-0 p-0">
                <div class="middle-top-area">
                  <div class="middle-top-left">
            ...
            <div class="all-message-body">
                  ...
                  <div class="ctx-with-draft">
                      <div class="ctx-body">
                        ...
                        <div class="dropdown">
                          ...
                          <ul class="dropdown-menu dropdown-show">
                            <li>
                              <a class="dropdown-item dropdown-heading active" href="#" onclick="editTextFunction()"> <span><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                              <path d="M4.29683 15.8334H5.32727L13.0437 8.11705L12.0132 7.08659L4.29683 14.803V15.8334ZM15.7167 7.21321L12.9042 4.4264L13.9908 3.33988C14.2354 3.09523 14.533 2.9729 14.8834 2.9729C15.2338 2.9729 15.5313 3.09523 15.776 3.33988L16.7904 4.35427C17.035 4.59893 17.1616 4.89219 17.1702 5.23407C17.1787 5.57594 17.0607 5.86921 16.816 6.11386L15.7167 7.21321ZM14.8129 8.12986L5.85931 17.0834H3.04688V14.2709L12.0004 5.3174L14.8129 8.12986ZM12.5244 7.59782L12.0132 7.08659L13.0437 8.11705L12.5244 7.59782Z" fill="#0036E3"/>
                            </svg></span> <span>Edit</span> </a>
                            </li>
                            <li>
              ...
              <div class="body-content edux-margin-left">
                ...
                <div class="ctx-img">
                  <img src="{{ asset('assets/frontend/img/chatavatar2.png') }}" alt="avatar">
                </div>
                ...
                <div class="ctx-text-area">
                  ...
                  <div class="edux-with-option">
                      <div class="ctx-body">
                        <p>Hello! Of course, I'd be delighted to assist you in creating a course plan for your university commerce conference in March. test</p>
                      </div>
              ...
              <div class="edux-all-message-body"> <span class="edux-today-margin">Today</span> </div>

              <div class="body-content edux-margin-left">
                <div class="ctx-img edux-ctx-img">
                  <img src="{{ asset('assets/frontend/img/chatavatar2.png') }}" alt="avatar">
                  <p class="edux-start-text"> <span></span> <span></span> <span></span></p>
                </div>
              </div>
...
function hide() {
  x = document.getElementById('leftSidebar');
  y =  document.getElementById('eduxMessage');
  x.className = 'hide';
  y.className = 'show';
...
function show() {
  ...
  function hide2() {
  xx = document.getElementById('leftSidebar2');
  yy =  document.getElementById('eduxMessage2');
  xx.className = 'hide';
  yy.className = 'show';
...
function FncRightSidebar() {
  var x = document.getElementById("rightOption");
  if (x.style.display === "none") {
    x.style.display = "block";
  } else {
    x.style.display = "none";
...
function editTextFunction() {
  var zz = document.getElementById("editTextBody");

...
@section('content')
    <section class="my-60">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="edux-sidebar-layout scholarship-database-page-layout border-0">
                            ...
                            <div class="edux-scholarship-top-item">
                                <div class="scholarship-database-content-list-item">
                                    ...
                                    <div class="scholarship-university-info">
                                        ...
                                        <p class="mb-0 text-sm fw-small">University of Melbourne | Australia</p>
                                    </div>
                                    <div class="scholarship-action">
                                        <div class="d-flex justify-content-end flex-wrap">
                                            ...
                                            <div class="dropdown">
                                                <button class="btn btn-outline-light m-1 btn-edux-wishlist" type="button"
                                    ...
                                    <div class="scholarship-details pt-3">
                                        <div class="edux-custom-table custom-table text-sm">
                                            <div class="tr">
                                                ...
                                                <div class="td fw-small">28 April 2024</div>
                                            </div>
                                            <div class="tr">
                                                <div class="td">Study area</div>
                                                <div class="td fw-small">Art, Architecture, Business</div>
                                            </div>
                                            <div class="tr">
                                                <div class="td">Study Level</div>
                                                <div class="td fw-small">Master of Philosophy, Doctors of
                                                    Philosophy, Master by research
                                                </div>
                                            </div>
                                            <div class="tr">
                                                <div class="td">Student type</div>
                                                <div class="td fw-small">International</div>
                                            </div>
                                            <div class="tr">
                                                <div class="td">Scholarship Website</div>
                                                <div class="td fw-small"><a class="text-decoration-underline"
                                                                             href="#">Click Here</a></div>
                                            </div>
                                            <div class="tr">
                                                <button class="edux-btn-primary  mt-3">Find Experts</button>
                                            </div>

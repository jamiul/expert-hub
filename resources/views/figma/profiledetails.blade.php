            ...
            <div class="row">
                ...
                <div class="col-xl-6 col-lg-8 col-md-8 ps-lg-5 mt-5 mt-lg-0">
                    ...
                    <div class="progress-step-content">
                        ...
                        <x-form.choice-static wire:model="title" label="">
                                ...
                                <div class="card-footer bg-white d-flex justify-content-center gap-3">
                                    <button class="icon-btn icon-btn-sm p-0">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                             viewBox="0 0 24 24" fill="none">
                                            <path
                                                d="M5.15425 19H6.39077L15.6504 9.74036L14.4139 8.50381L5.15425 17.7635V19ZM18.858 8.65576L15.4831 5.31158L16.787 4.00776C17.0806 3.71417 17.4376 3.56738 17.8581 3.56738C18.2786 3.56738 18.6356 3.71417 18.9292 4.00776L20.1465 5.22503C20.4401 5.51862 20.592 5.87053 20.6023 6.28078C20.6125 6.69103 20.4709 7.04295 20.1773 7.33653L18.858 8.65576ZM17.7735 9.75573L7.02922 20.5H3.6543V17.125L14.3985 6.38078L17.7735 9.75573ZM15.0274 9.11728L14.4139 8.50381L15.6504 9.74036L15.0274 9.11728Z"
                                    ...
                                    <button class="icon-btn icon-btn-sm p-0" data-bs-toggle="modal"
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                             viewBox="0 0 24 24" fill="none">
                                            <path
                                                d="M7.3077 20.5C6.80898 20.5 6.38302 20.3234 6.02982 19.9702C5.67661 19.617 5.5 19.191 5.5 18.6923V6.00005H4.5V4.50008H8.99997V3.61548H15V4.50008H19.5V6.00005H18.5V18.6923C18.5 19.1975 18.325 19.625 17.975 19.975C17.625 20.325 17.1974 20.5 16.6922 20.5H7.3077ZM17 6.00005H6.99997V18.6923C6.99997 18.7821 7.02883 18.8558 7.08652 18.9135C7.14423 18.9712 7.21795 19.0001 7.3077 19.0001H16.6922C16.7692 19.0001 16.8397 18.968 16.9038 18.9039C16.9679 18.8398 17 18.7693 17 18.6923V6.00005ZM9.40385 17.0001H10.9038V8.00005H9.40385V17.0001ZM13.0961 17.0001H14.5961V8.00005H13.0961V17.0001Z"
                                                fill="#191D24" fill-opacity="0.7"/>
                                        </svg>
                                    </button>
                                </div>
                    ...
                    <div class="d-flex justify-content-between gap-5 progress-step-control-btn-wrapper">
                        <button class="btn btn-md btn-outline-primary d-flex align-items-center justify-content-center">
                            <svg class="me-2" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                 viewBox="0 0 24 24" fill="none">

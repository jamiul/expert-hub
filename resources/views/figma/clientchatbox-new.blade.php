                          ...
                          fill="#A1A0A5"></path>
                                    ...
                                    <li>
                                        <a class="dropdown-item dropdown-heading " href="#"> <span><svg
                                                    ...
                                                    viewBox="0 0 20 20" fill="none">
                    <path
                        d="M13.7513 2.5C16.2826 2.5 18.3346 4.58333 18.3346 7.5C18.3346 13.3333 12.0846 16.6667 10.0013 17.9167C7.91797 16.6667 1.66797 13.3333 1.66797 7.5C1.66797 4.58333 3.7513 2.5 6.2513 2.5C7.80128 2.5 9.16797 3.33333 10.0013 4.16667C10.8346 3.33333 12.2013 2.5 13.7513 2.5ZM10.7796 15.5032C11.5142 15.0404 12.1763 14.5796 12.7971 14.0858C15.2794 12.1108 16.668 9.95292 16.668 7.5C16.668 5.53397 15.3871 4.16667 13.7513 4.16667C12.8547 4.16667 11.8841 4.64092 11.1798 5.34517L10.0013 6.52369L8.8228 5.34517C8.11854 4.64092 7.14789 4.16667 6.2513 4.16667C4.63385 4.16667 3.33464 5.54708 3.33464 7.5C3.33464 9.95292 4.72319 12.1108 7.20559 14.0858C7.8263 14.5796 8.48839 15.0404 9.22305 15.5032C9.4718 15.6599 9.71889 15.8107 10.0013 15.9793C10.2837 15.8107 10.5308 15.6599 10.7796 15.5032Z"
                        fill="#A1A0A5"></path>
                  </svg></span> <span>Favourites</span> </a>
                                    </li>

                                    <li>
                                        <a class="dropdown-item dropdown-heading"> <span><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                    viewBox="0 0 20 20" fill="none">
                    <path
                        d="M2.5013 8.33333H1.66797V3.33578C1.66797 2.87419 2.04739 2.5 2.49447 2.5H17.5081C17.9646 2.5 18.3346 2.8649 18.3346 3.33578V8.33333H17.5013V16.6679C17.5013 17.1275 17.1306 17.5 16.6735 17.5H3.32914C2.87194 17.5 2.5013 17.1271 2.5013 16.6679V8.33333ZM15.8346 8.33333H4.16797V15.8333H15.8346V8.33333ZM3.33464 4.16667V6.66667H16.668V4.16667H3.33464ZM7.5013 10H12.5013V11.6667H7.5013V10Z"
                        fill="#A1A0A5"></path>
            ...
            <div class="chatbox-content-area">
                <div class="chatbox-recipient-area">
                    <div class="chatbox-recipient-inner">
                        ...
                        <div>
                            <h3>Michel Jhon <span>| Curriculum Expert</span></h3>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-show">
                                            ...
                                            <button class="dropdown-item dropdown-heading"
                                                    onclick="startMessageEdit()"> <span><svg
                                                        xmlns="http://www.w3.org/2000/svg"
                                                        width="20" height="20"
                                                        viewBox="0 0 20 20" fill="none">
                  <path
                      d="M4.29683 15.8334H5.32727L13.0437 8.11705L12.0132 7.08659L4.29683 14.803V15.8334ZM15.7167 7.21321L12.9042 4.4264L13.9908 3.33988C14.2354 3.09523 14.533 2.9729 14.8834 2.9729C15.2338 2.9729 15.5313 3.09523 15.776 3.33988L16.7904 4.35427C17.035 4.59893 17.1616 4.89219 17.1702 5.23407C17.1787 5.57594 17.0607 5.86921 16.816 6.11386L15.7167 7.21321ZM14.8129 8.12986L5.85931 17.0834H3.04688V14.2709L12.0004 5.3174L14.8129 8.12986ZM12.5244 7.59782L12.0132 7.08659L13.0437 8.11705L12.5244 7.59782Z"
                      fill="#0036E3"/>
                </svg></span> <span>Edit</span></button>

                                            <button class="dropdown-item dropdown-heading"> <span>
                                                    <svg
                                                        xmlns="http://www.w3.org/2000/svg"
                                                        width="20" height="20"
                                                        viewBox="0 0 20 20" fill="none">
                  <path
                      d="M7.5 15.0001C7.04167 15.0001 6.64931 14.8369 6.32292 14.5105C5.99653 14.1841 5.83333 13.7917 5.83333 13.3334V3.33341C5.83333 2.87508 5.99653 2.48272 6.32292 2.15633C6.64931 1.82994 7.04167 1.66675 7.5 1.66675H15C15.4583 1.66675 15.8507 1.82994 16.1771 2.15633C16.5035 2.48272 16.6667 2.87508 16.6667 3.33341V13.3334C16.6667 13.7917 16.5035 14.1841 16.1771 14.5105C15.8507 14.8369 15.4583 15.0001 15 15.0001H7.5ZM7.5 13.3334H15V3.33341H7.5V13.3334ZM4.16667 18.3334C3.70833 18.3334 3.31597 18.1702 2.98958 17.8438C2.66319 17.5174 2.5 17.1251 2.5 16.6667V5.00008H4.16667V16.6667H13.3333V18.3334H4.16667Z"
                      fill="#191D24"/>
                </svg></span> <span>Copy</span></button>

                                            <button class="dropdown-item dropdown-heading"> <span><svg
                                                        xmlns="http://www.w3.org/2000/svg"
                                                        width="20" height="20"
                                                        viewBox="0 0 20 20" fill="none">
                  <path
                      d="M15.8333 15.8334V12.5001C15.8333 11.8056 15.5903 11.2154 15.1042 10.7292C14.6181 10.2431 14.0278 10.0001 13.3333 10.0001H5.6875L8.6875 13.0001L7.5 14.1667L2.5 9.16675L7.5 4.16675L8.6875 5.33341L5.6875 8.33341H13.3333C14.4861 8.33341 15.4688 8.73966 16.2812 9.55216C17.0938 10.3647 17.5 11.3473 17.5 12.5001V15.8334H15.8333Z"
                      fill="#191D24"/>
                        ...
                        <div class="chatbox-message-editor">
                                ...
                                <div class="message-editor-styling-action">
                                    ...
                                    <button class="icon-btn">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                             viewBox="0 0 24 24" fill="none">
                                            <path
                                                d="M5.39453 18.625V16.8173H9.21183L12.4522 7.18265H8.63493V5.375H17.7887V7.18265H14.2791L11.0387 16.8173H14.5483V18.625H5.39453Z"
                                                fill="#303744" fill-opacity="0.7"></path>
                                        </svg>
                                    </button>
                                    <button class="icon-btn">
                                    ...
                                    <button class="icon-btn">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                             viewBox="0 0 24 24" fill="none">
                                            <path
                                                d="M7.99758 17.6538L2.34375 12L7.99758 6.34619L9.06678 7.41539L4.46678 12.0154L9.0514 16.6L7.99758 17.6538ZM15.9976 17.6538L14.9284 16.5846L19.5284 11.9846L14.9438 7.40002L15.9976 6.34619L21.6514 12L15.9976 17.6538Z"
                                                fill="#303744" fill-opacity="0.7"></path>
                                        </svg>
                                    </button>
                                </div>
                                    ...
                                    <button class="icon-btn">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            ...
                                            <path
                                                ...
                                                fill="#303744" fill-opacity="0.5"></path>
                                        </svg>
                                    </button>
                                    <button class="icon-btn">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            ...
                            <div class="chatbox-message-mobile-action">
                                ...
                                <button onclick="startMobileMessageEdit()"><span><svg xmlns="http://www.w3.org/2000/svg"
                                                                                      width="16" height="16"
                                                                                      viewBox="0 0 16 16" fill="none">
                      <path
                          d="M3.43619 12.6667H4.26054L10.4337 6.49358L9.6093 5.66922L3.43619 11.8423V12.6667ZM12.5721 5.77052L10.3221 3.54107L11.1913 2.67185C11.3871 2.47613 11.6251 2.37827 11.9054 2.37827C12.1858 2.37827 12.4238 2.47613 12.6195 2.67185L13.431 3.48337C13.6268 3.67909 13.728 3.9137 13.7349 4.1872C13.7417 4.4607 13.6473 4.69531 13.4515 4.89103L12.5721 5.77052ZM11.849 6.50383L4.68617 13.6667H2.43622V11.4167L9.59903 4.25387L11.849 6.50383ZM10.0183 6.0782L9.6093 5.66922L10.4337 6.49358L10.0183 6.0782Z"
                          fill="#0036E3"></path>
                    </svg></span> <span>Edit</span></button>
                                <button><span><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                   viewBox="0 0 16 16" fill="none">
                      <path
                          d="M6 12C5.63333 12 5.31944 11.8695 5.05833 11.6083C4.79722 11.3472 4.66667 11.0333 4.66667 10.6667V2.66668C4.66667 2.30001 4.79722 1.98612 5.05833 1.72501C5.31944 1.4639 5.63333 1.33334 6 1.33334H12C12.3667 1.33334 12.6806 1.4639 12.9417 1.72501C13.2028 1.98612 13.3333 2.30001 13.3333 2.66668V10.6667C13.3333 11.0333 13.2028 11.3472 12.9417 11.6083C12.6806 11.8695 12.3667 12 12 12H6ZM6 10.6667H12V2.66668H6V10.6667ZM3.33333 14.6667C2.96667 14.6667 2.65278 14.5361 2.39167 14.275C2.13056 14.0139 2 13.7 2 13.3333V4.00001H3.33333V13.3333H10.6667V14.6667H3.33333Z"
                          fill="#0036E3"></path>
                    </svg></span> <span>Copy</span></button>

                                <button><span><svg xmlns="http://www.w3.org/2000/svg" width="17" height="16"
                                                   viewBox="0 0 17 16" fill="none">
                      <path
                          d="M13.1667 12.6667V10C13.1667 9.44446 12.9722 8.97223 12.5833 8.58334C12.1944 8.19445 11.7222 8.00001 11.1667 8.00001H5.05L7.45 10.4L6.5 11.3333L2.5 7.33334L6.5 3.33334L7.45 4.26668L5.05 6.66668H11.1667C12.0889 6.66668 12.875 6.99168 13.525 7.64168C14.175 8.29168 14.5 9.07779 14.5 10V12.6667H13.1667Z"
                          fill="#0036E3"></path>
                    </svg></span> <span>Reply</span></button>
                        ...
                        <span>
                          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"
                               fill="none">
                      <path
                          d="M7.99996 13.3333C7.63329 13.3333 7.3194 13.2028 7.05829 12.9417C6.79718 12.6805 6.66663 12.3667 6.66663 12C6.66663 11.6333 6.79718 11.3194 7.05829 11.0583C7.3194 10.7972 7.63329 10.6667 7.99996 10.6667C8.36663 10.6667 8.68051 10.7972 8.94163 11.0583C9.20274 11.3194 9.33329 11.6333 9.33329 12C9.33329 12.3667 9.20274 12.6805 8.94163 12.9417C8.68051 13.2028 8.36663 13.3333 7.99996 13.3333ZM7.99996 9.33332C7.63329 9.33332 7.3194 9.20277 7.05829 8.94166C6.79718 8.68054 6.66663 8.36666 6.66663 7.99999C6.66663 7.63332 6.79718 7.31943 7.05829 7.05832C7.3194 6.79721 7.63329 6.66666 7.99996 6.66666C8.36663 6.66666 8.68051 6.79721 8.94163 7.05832C9.20274 7.31943 9.33329 7.63332 9.33329 7.99999C9.33329 8.36666 9.20274 8.68054 8.94163 8.94166C8.68051 9.20277 8.36663 9.33332 7.99996 9.33332ZM7.99996 5.33332C7.63329 5.33332 7.3194 5.20277 7.05829 4.94166C6.79718 4.68055 6.66663 4.36666 6.66663 3.99999C6.66663 3.63332 6.79718 3.31943 7.05829 3.05832C7.3194 2.79721 7.63329 2.66666 7.99996 2.66666C8.36663 2.66666 8.68051 2.79721 8.94163 3.05832C9.20274 3.31943 9.33329 3.63332 9.33329 3.99999C9.33329 4.36666 9.20274 4.68055 8.94163 4.94166C8.68051 5.20277 8.36663 5.33332 7.99996 5.33332Z"
                          fill="#0036E3"></path>
                    </svg>
                  </span>
                                    <span>More</span>

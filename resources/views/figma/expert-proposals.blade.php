 ...
 <nav class="bg-primary sub__nav">
      <div class="container">
         <ul class="d-flex ps-0 list-unstyled mb-0">
               ...
               <li class="me-3">
                  <a href="#" class="text-white fw-medium px-2 py-3 d-inline-block active">Proposal</a>
               </li>
               <li class="me-3">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="activeTab" role="tabpanel" aria-labelledby="activeTab-tab">
                        ...
                        <div class="border-top py-4 px-40 mb-3">
                            <a href="#" class="btn btn-primary px-40 py-11 fs-15 fw-medium me-3">Search for Projects</a>
                            <a href="#" class="btn btn-outline-primary px-40 py-11 fs-15 fw-medium w-auto h-auto lh-base">Manage your Profile</a>
                        </div>
                    </div><!--.//activeTab-->

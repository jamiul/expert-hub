            ...
            <div class="dashboard-inprogress-area">
              <div class="dashboard-inprogress">
                <div class="admin-tab-nav-area d-flex flex-row justify-content-between">
                  ...
                  <button type="button" class="edux-btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModalform" data-bs-whatever="@mdo">
                    ...
                    <tbody>
                                ...
                                <ul class="dropdown-menu admin-d-item">
                                  ...
                                  <li>
                                    <button class="dropdown-item">
                                      <span type="button" data-bs-toggle="modal" data-bs-target="#exampleModalDelete" data-bs-whatever="@mdo">Delete</span>
                                    </button>
                                  </li>
                                  <li>
                      ...
                      <tr>
                        <td class="edux-scholarship-details-cell text-nowrap">
                            ...
                            <span class="badge rounded-pill text-bg-warning mt-2">Both</span>
                        </td>
                        <td>23 January 2024
                        ...
                        <div class="col-12 mt-4">
                          <div class="col-md-12">
                            <div class="form-check edux-form-check-scholarship">
                              ...
                              <label class="form-check-label edux-label" for="gridCheck3"> Automatic Consideration </label>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="row mt-2">
                            <div class="col-md-3">
                              <div class="form-check edux-form-check-scholarship">
                                ...
                                <label class="form-check-label edux-label" for="gridCheck"> University </label>
                              </div>
                            </div>
                            <div class="col-md-3">
                              <div class="form-check edux-form-check-scholarship">
                                <input class="form-check-input" type="checkbox" id="gridCheck1">
                                <label class="form-check-label edux-label" for="gridCheck1"> Govt </label>
                              </div>
                            </div>
                            <div class="col-md-3">
                              <div class="form-check edux-form-check-scholarship">
                                <input class="form-check-input" type="checkbox" id="gridCheck2">
                                <label class="form-check-label edux-label" for="gridCheck2"> Project </label>
                              </div>
                            </div>
                          </div>
                          <div class="row mt-4">

          ...
          <div class="dashboard-inprogress-area">
                <div class="dashboard-inprogress">
                  <div class="admin-tab-nav-area d-flex flex-row justify-content-between">
                      ...
                      <button type="button" class="edux-btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModalform" data-bs-whatever="@mdo"> <span class="arrow-left">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                          <path d="M11.25 12.75H5.5V11.25H11.25V5.5H12.75V11.25H18.5V12.75H12.75V18.5H11.25V12.75Z" fill="white"></path>
                        </svg>
                     ...
                     <div class="row">
                      <div class="edux-scholarship-heading-area">
                        <ul class="admin-policy-area">
                          ...
                          <li class="edux-currency">Currency</li>
                          <li class="edux-value">Value</li>
                        ...
                        <div class="row px-0 mx-0 admin-m-bottom ">
                          <div class="admin-policy-area d-flex flex-row align-items-center justify-content-start">
                            ...
                            <div class="edux-study-level edux-study">
                              <p>Master of Philosophy,</p>
                               <p>Doctors of Philosophy</p>
                               <p>Master by research</p>
                            </div>

                            <div class="edux-study-area edux-area">
                              <p>Art, Architecture,</p>  <p>Business</p>
                            </div>

                            <div class="edux-currency">
                              <span>AUD</span>
                            </div>
                            <div class="edux-value edux-value-currency">
                              <span>$2400</span>
                            </div>
                            ...
                            <div class="edux-status">
                              <div class="check-box-option">
                                  <ul>
                                    <li>
                                    <div class="switch-button switch-button-sm" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                  ...
                                  <ul class="dropdown-menu admin-d-item ">
                                    <li>
                                      <a class="dropdown-item  dropdown-heading active" href="#">
                                        <span type="button" data-bs-toggle="modal" data-bs-target="#exampleModalformedit" data-bs-whatever="@mdo">Edit</span>
                                      </a>
                                    </li>
                                    <li>

                                      <a class="dropdown-item" href="#"><span type="button" data-bs-toggle="modal" data-bs-target="#exampleModalDelete" data-bs-whatever="@mdo">Delete</span></a>
                                    </li>
                                    <li>
                                      <a class="dropdown-item" href="#">Contact to Institution</a>
                                    </li>
                                  </ul>
                                </div>
                              </div>
                          ...
                          <div class="admin-policy-area d-flex flex-row align-items-center justify-content-start">
                            ...
                            <div class="policy-option">
                                ...
                                <div class="dropdown">
                                  ...
                                  <ul class="dropdown-menu admin-d-item ">
                                    <li>
                                      <a class="dropdown-item  dropdown-heading active" href="#">Edit</a>
                                    </li>
                                    <li>
                              ...
                              <div class="check-box-option">
                                  <ul>
                                    ...
                                    <div class="switch-button switch-button-sm" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                        ...
                                        <span><label for="item4"></label></span>
                                      </div>
                                    </li>
                                  </ul>
                              </div>
                                  ...
                                  <ul>
                                    <li>
                                      <div class="switch-button switch-button-sm" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                        ...
                                        <span><label for="item5"></label></span>
                                      </div>
                                    </li>
                                  </ul>
                              </div>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content edux-status-modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary edux-btn-border-primary-cancel" data-bs-dismiss="modal">Cancel</button>
        <button type="button" class="btn btn-primary edux-btn-primary-yes">Yes</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal" data-bs-whatever="@mdo" id="exampleModalDelete">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content edux-status-modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary edux-btn-border-primary-cancel" data-bs-dismiss="modal">Cancel</button>
        <button type="button" class="btn btn-primary edux-btn-primary-delete">Delete</button>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="modal-dialog edux-scholarship-modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body edux-scholarship-modal-body">
        ...
        <form class="row g-3">
          <div class="col-12">
            <label for="inputAddress" class="form-label edux-label">Scholarship Title</label>
          ...
          <div class="col-md-6 mt-4">
            ...
            <input type="text" class="form-control edux-input-type university-search" id="text" placeholder="Select university">
          </div>
          <div class="col-md-6 mt-4">
            <label for="inputPassword4" class="form-label edux-label">Student Type</label>
          ...
          <div class="col-md-6 mt-4">
            <label for="inputEmail4" class="form-label edux-label">Find Supervisor</label>
            <input type="text" class="form-control edux-input-type" id="text" placeholder="Add university find supervisor url">
          </div>
          <div class="col-md-6 mt-4">
            <label for="inputPassword4" class="form-label edux-label">Application Process</label>
            <input type="text" class="form-control edux-input-type" id="text" placeholder="Add application process url">
          </div>


          <div class="col-md-6 mt-4">
            <label for="inputEmail4" class="form-label edux-label">Scholarship Value</label>
            <input type="number" class="form-control edux-input-type" id="text" placeholder="EX: $1000">
          </div>
          <div class="col-md-6 mt-4">
          ...
          <div class="col-12 mt-4">
            <label for="inputAddress2" class="form-label edux-label">Study Level</label>
            <select id="inputState" class="form-select edux-input-type">
          ...
          <div class="col-12 mt-4">
            <label for="inputAddress2" class="form-label edux-label">Study Area</label>
            <select id="inputState" class="form-select edux-input-type">
                <option selected>Select options</option>
                <option>Select options</option>
                <option>Select options</option>
          ...
          <div class="col-12 mt-4">
            <p class="edux-fund-type">Fund Type</p>
              <div class="row mt-2">
                ...
                <label class="form-check-label edux-label" for="gridCheck">
                 University
                </label>
                </div>
                </div>
                <div class="col-md-3">
                  ...
                  <label class="form-check-label edux-label" for="gridCheck1">
                  Govt
                  </label>
                 </div>
                </div>
                <div class="col-md-3">
                    <div class="form-check edux-form-check-scholarship">
                      ...
                      <label class="form-check-label edux-label" for="gridCheck2">
                        Project
                      </label>
                    </div>
                </div>
              ...
              <div class="row mt-4">
                  ...
                  <div class="select-date">
                      <div class="date-item">
                        <div class="study-level">
                          <div class="calendar-box position-relative">
                            <input type="text"  class="edux-scholarship-datetype" id="dateInput" placeholder="Select deadline">
                            <div class="calendar" id="calendar">
                              <div class="header">
                                <button id="prevBtn">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="19" viewBox="0 0 18 19" fill="none">
      ...
      <div class="modal-footer edux-modal-footer">
        <button type="button" class="btn btn-secondary edux-btn-border-primary-cancel" data-bs-dismiss="modal">Cancel</button>
        <button type="button" class="btn btn-primary edux-btn-primary-yes">Create Scholarship</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="exampleModalformedit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog edux-scholarship-modal-dialog">
    <div class="modal-content">
      <div class="modal-header border-0 edux-scholarship-modal-header">
        ...
        <form class="row g-3">
          ...
          <div class="col-12 mt-4">
            ...
            <div class="edux-editable-content position-relative">
              <p><span>Bachelor's Degree</span> <span> <a href="#"><img src="{{ asset('assets/frontend/img/space-delete.png') }}" alt=""></a> </span></p>
              <p class="content-no-close"><span class="count-close-text">2</span> <span class="edux-count-close"> <a href="#"><img src="{{ asset('assets/frontend/img/study-close.png') }}" alt=""> </a> </span></p>
            </div>
          </div>
      ...
      <div class="modal-footer edux-modal-footer">
        <button type="button" class="btn btn-secondary edux-btn-border-primary-cancel" data-bs-dismiss="modal">Cancel</button>
        <button type="button" class="btn btn-primary edux-btn-primary-yes">Update Scholarship</button>
      </div>
    </div>
  </div>
</div>

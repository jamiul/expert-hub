        ...
        <div class="register-form">
          ...
          <div class="container">
              <form id="form" action="/">
                  ...
                  <div class="input-control  input-control-email position-relative">
                      <label for="username" class=" position-absolute email-level">Email Address</label>
                      <input class="login-input" id="username" name="username" type="text"  placeholder="username"> 
                      <div class="error"></div>
                  </div>

                  <div class="input-control d-none">
                      <label for="email">Email</label>
                      <input id="email" name="email" type="text">
                      <div class="error"></div>
                  </div>
                  
                  <div class="input-control input-control-password position-relative">
                      <label for="password" class=" position-absolute password-level">Password</label>
                      <input id="password" class="login-input" name="password" type="password" placeholder="password" >
                      <a href="" class="eye-off position-absolute"><span class="material-symbols-outlined">visibility_off</span></a>
                      <div class="error"></div>
                  </div>
                  <div class="input-control d-none">
                  ...
                  <div class="password-forget-area mt-3 d-flex flex-row justify-content-between">
                    <div class="form-check d-flex align-items-center gap-2">
                      <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault">
                      <label class="form-check-label kip-login" for="flexCheckDefault">
                          Keep me logged in
                      </label>
                    </div>
          ...
          <div class="creat-button">
            <a  type="submit" href="{{url('figma/client-dashboardhome')}}">Login</a>
          </div>
          ...
          <div class="default-login-area d-flex flex-column">

            <div class="google-login  d-flex flex-row align-items-center">
                  <a href="#">  <img src="{{ asset('assets/frontend/img/login-img/icons_google.png') }}" alt=""> </a>
                  <a href="#" class="g-login-text">Continue with Google</a>
            </div>

            <div class="apple-login   d-flex flex-row align-items-center">
                  <a href="#">  <img src="{{ asset('assets/frontend/img/login-img/icons_apple.png') }}" alt=""> </a>
                  <a href="#"  class="g-login-text">Continue with Apple</a>
            </div>

            <div class="linked-login   d-flex flex-row align-items-center">
                  <a href="#">  <img src="{{ asset('assets/frontend/img/login-img/LinkedIn_icon.png') }}" alt=""> </a>
                  <a href="#"  class="g-login-text">Continue with LinkedIn</a>
            </div>

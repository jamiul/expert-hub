...
<div class="setting-area">
    ...
    <span class="position-absolute translate-middle p-1 bg-danger border border-5 border-light rounded-circle top-batch-more">9+</span>
      ...
      <div class="dropdown">
            <a class="drop__btn rounded-circle p-0 d-inline-flex justify-content-center align-items-center overflow-hidden show edux-profile-img" href="#" role="button" id="messageDrop" data-bs-toggle="dropdown" aria-expanded="true">
               <img src="{{ asset('/assets/frontend/default/img/expert_dashboard/profile-img.png') }}" class="rounded-circle" alt="avatar">
            </a>
            <div class="dropdown-menu profile__dropdown bg-white border-0" aria-labelledby="dropdownMenuLink" onclick="stopPropagation(event)">
               <div class="text-center">
